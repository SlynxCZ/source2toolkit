...
#include "source2toolkit/schema/entity/iclasses/IInfoDeathmatchSpawn.h"
#include "schema/entity/classes/CInfoDeathmatchSpawn.h"

class CInfoDeathmatchSpawnImpl : public virtual IInfoDeathmatchSpawn
{
...
public:
    explicit CInfoDeathmatchSpawnImpl(void* p) : m_pReal(p) {}
