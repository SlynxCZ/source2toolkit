...
#include "source2toolkit/schema/entity/iclasses/IEconItemView.h"
#include "schema/entity/classes/CEconItemView.h"

class CEconItemViewImpl : public virtual IEconItemView
{
...
public:
    explicit CEconItemViewImpl(void* p) : m_pReal(p) {}
