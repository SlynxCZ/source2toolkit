...
#ifndef _INCLUDE_CPLAYERPAWNCOMPONENTIMPL_H
#define _INCLUDE_CPLAYERPAWNCOMPONENTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/iclasses/IPlayerPawnComponent.h"
#include "schema/entity/classes/CPlayerPawnComponent.h"

class CPlayerPawnComponentImpl : public virtual IPlayerPawnComponent
{
...
public:
    explicit CPlayerPawnComponentImpl(void* p) : m_pReal(p) {}
