...
#include "source2toolkit/schema/entity/iclasses/IInfoPlayerCounterterrorist.h"
#include "schema/entity/classes/CInfoPlayerCounterterrorist.h"

class CInfoPlayerCounterterroristImpl : public virtual IInfoPlayerCounterterrorist
{
...
public:
    explicit CInfoPlayerCounterterroristImpl(void* p) : m_pReal(p) {}
