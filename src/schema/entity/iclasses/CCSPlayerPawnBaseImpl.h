...
#include "source2toolkit/schema/entity/iclasses/ICSPlayerPawnBase.h"
...
public:
    CTouchExpansionComponent& CTouchExpansionComponent() override { return Real()->m_CTouchExpansionComponent(); }
    void CTouchExpansionComponentUpdated() override { Real()->m_CTouchExpansionComponent.NetworkStateChanged(); }
