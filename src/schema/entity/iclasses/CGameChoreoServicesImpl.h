...
#include "source2toolkit/schema/entity/iclasses/IGameChoreoServices.h"
#include "schema/entity/classes/CGameChoreoServices.h"

class CGameChoreoServicesImpl : public virtual IGameChoreoServices
{
...
public:
    explicit CGameChoreoServicesImpl(void* p) : m_pReal(p) {}
