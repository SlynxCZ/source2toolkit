...
#ifndef _INCLUDE_CLIGHTORTHOENTITYIMPL_H
#define _INCLUDE_CLIGHTORTHOENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ILightOrthoEntity.h"
...
public:
    explicit CLightOrthoEntityImpl(CLightOrthoEntity* p) : CLightEntityImpl(p) {}

private:
    CLightOrthoEntity* Real() { return static_cast<CLightOrthoEntity*>(m_pReal); }
    CLightOrthoEntity* Real() const { return static_cast<CLightOrthoEntity*>(m_pReal); }
