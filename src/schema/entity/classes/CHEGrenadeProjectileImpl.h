...
#ifndef _INCLUDE_CHEGRENADEPROJECTILEIMPL_H
#define _INCLUDE_CHEGRENADEPROJECTILEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IHEGrenadeProjectile.h"
...
public:
    explicit CHEGrenadeProjectileImpl(CHEGrenadeProjectile* p) : CBaseCSGrenadeProjectileImpl(p) {}

private:
    CHEGrenadeProjectile* Real() { return static_cast<CHEGrenadeProjectile*>(m_pReal); }
    CHEGrenadeProjectile* Real() const { return static_cast<CHEGrenadeProjectile*>(m_pReal); }
