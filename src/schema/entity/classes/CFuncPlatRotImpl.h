...
#ifndef _INCLUDE_CFUNCPLATROTIMPL_H
#define _INCLUDE_CFUNCPLATROTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncPlatRot.h"
...
public:
    explicit CFuncPlatRotImpl(CFuncPlatRot* p) : CFuncPlatImpl(p) {}

private:
    CFuncPlatRot* Real() { return static_cast<CFuncPlatRot*>(m_pReal); }
    CFuncPlatRot* Real() const { return static_cast<CFuncPlatRot*>(m_pReal); }

public:
    CFuncPlatRot* GetOriginal() const override { return Real(); }
