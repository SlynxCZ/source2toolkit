...
#ifndef _INCLUDE_ROTATORQUEUEENTRY_TIMPL_H
#define _INCLUDE_ROTATORQUEUEENTRY_TIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IRotatorQueueEntry_t.h"
#include "schema/entity/classes/RotatorQueueEntry_t.h"

class RotatorQueueEntry_tImpl : public virtual IRotatorQueueEntry_t
{
...
public:
    explicit RotatorQueueEntry_tImpl(void* p) : m_pReal(p) {}

private:
    RotatorQueueEntry_t* Real() { return static_cast<RotatorQueueEntry_t*>(m_pReal); }
    RotatorQueueEntry_t* Real() const { return static_cast<RotatorQueueEntry_t*>(m_pReal); }
