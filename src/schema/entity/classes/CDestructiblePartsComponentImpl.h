...
#ifndef _INCLUDE_CDESTRUCTIBLEPARTSCOMPONENTIMPL_H
#define _INCLUDE_CDESTRUCTIBLEPARTSCOMPONENTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IDestructiblePartsComponent.h"
#include "schema/entity/classes/CDestructiblePartsComponent.h"

class CDestructiblePartsComponentImpl : public virtual IDestructiblePartsComponent
{
...
public:
    explicit CDestructiblePartsComponentImpl(void* p) : m_pReal(p) {}

private:
    CDestructiblePartsComponent* Real() { return static_cast<CDestructiblePartsComponent*>(m_pReal); }
    CDestructiblePartsComponent* Real() const { return static_cast<CDestructiblePartsComponent*>(m_pReal); }
...
public:
    ...
    CBaseAnimGraphDestructibleParts_GraphController*& AnimGraphDestructibleGraphController() override { return Real()->m_pAnimGraphDestructibleGraphController(); }
    void AnimGraphDestructibleGraphControllerUpdated() override { Real()->m_pAnimGraphDestructibleGraphController.NetworkStateChanged(); }
};
