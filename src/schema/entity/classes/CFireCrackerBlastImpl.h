...
#ifndef _INCLUDE_CFIRECRACKERBLASTIMPL_H
#define _INCLUDE_CFIRECRACKERBLASTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFireCrackerBlast.h"
...
public:
    explicit CFireCrackerBlastImpl(CFireCrackerBlast* p) : CInfernoImpl(p) {}

private:
    CFireCrackerBlast* Real() { return static_cast<CFireCrackerBlast*>(m_pReal); }
    CFireCrackerBlast* Real() const { return static_cast<CFireCrackerBlast*>(m_pReal); }
