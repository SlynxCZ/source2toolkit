...
private:
    ...
    CSoundEventPathCornerEntity* Real() const { return static_cast<CSoundEventPathCornerEntity*>(m_pReal); }

public:
    CSoundEventPathCornerEntity* GetOriginal() const override { return Real(); }
