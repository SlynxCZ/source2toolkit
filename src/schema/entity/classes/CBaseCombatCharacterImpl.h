...
#include "source2toolkit/schema/entity/classes/IBaseCombatCharacter.h"
...
private:
    ...
    CBaseCombatCharacter* Real() const { return static_cast<CBaseCombatCharacter*>(m_pReal); }

public:
    CBaseCombatCharacter* GetOriginal() const override { return Real(); }
