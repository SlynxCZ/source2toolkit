...
#include "source2toolkit/schema/entity/classes/IPointAngularVelocitySensor.h"
...
private:
    ...
    CPointAngularVelocitySensor* Real() const { return static_cast<CPointAngularVelocitySensor*>(m_pReal); }

public:
    CPointAngularVelocitySensor* GetOriginal() const override { return Real(); }
