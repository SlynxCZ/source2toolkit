...
#ifndef _INCLUDE_CORNAMENTPROPIMPL_H
#define _INCLUDE_CORNAMENTPROPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IOrnamentProp.h"
...
public:
    explicit COrnamentPropImpl(COrnamentProp* p) : CDynamicPropImpl(p) {}

private:
    COrnamentProp* Real() { return static_cast<COrnamentProp*>(m_pReal); }
    COrnamentProp* Real() const { return static_cast<COrnamentProp*>(m_pReal); }

public:
    COrnamentProp* GetOriginal() const override { return Real(); }
    CUtlSymbolLarge& InitialOwner() override { return Real()->m_initialOwner(); }
