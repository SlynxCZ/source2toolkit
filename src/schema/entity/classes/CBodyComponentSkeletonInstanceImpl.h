...
#ifndef _INCLUDE_CBODYCOMPONENTSKELETONINSTANCEIMPL_H
#define _INCLUDE_CBODYCOMPONENTSKELETONINSTANCEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IBodyComponentSkeletonInstance.h"
...
public:
    explicit CBodyComponentSkeletonInstanceImpl(CBodyComponentSkeletonInstance* p) : CBodyComponentImpl(p) {}

private:
    CBodyComponentSkeletonInstance* Real() { return static_cast<CBodyComponentSkeletonInstance*>(m_pReal); }
    CBodyComponentSkeletonInstance* Real() const { return static_cast<CBodyComponentSkeletonInstance*>(m_pReal); }
