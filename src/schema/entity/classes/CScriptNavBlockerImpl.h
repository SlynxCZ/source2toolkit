...
#ifndef _INCLUDE_CSCRIPTNAVBLOCKERIMPL_H
#define _INCLUDE_CSCRIPTNAVBLOCKERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IScriptNavBlocker.h"
...
public:
    explicit CScriptNavBlockerImpl(CScriptNavBlocker* p) : CFuncNavBlockerImpl(p) {}

private:
    CScriptNavBlocker* Real() { return static_cast<CScriptNavBlocker*>(m_pReal); }
    CScriptNavBlocker* Real() const { return static_cast<CScriptNavBlocker*>(m_pReal); }

public:
    CScriptNavBlocker* GetOriginal() const override { return Real(); }
