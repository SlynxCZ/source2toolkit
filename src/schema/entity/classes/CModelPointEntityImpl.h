...
#ifndef _INCLUDE_CMODELPOINTENTITYIMPL_H
#define _INCLUDE_CMODELPOINTENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IModelPointEntity.h"
...
public:
    explicit CModelPointEntityImpl(CModelPointEntity* p) : CBaseModelEntityImpl(p) {}

private:
    CModelPointEntity* Real() { return static_cast<CModelPointEntity*>(m_pReal); }
    CModelPointEntity* Real() const { return static_cast<CModelPointEntity*>(m_pReal); }
