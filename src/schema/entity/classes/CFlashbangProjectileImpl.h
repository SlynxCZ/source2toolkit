...
#include "source2toolkit/schema/entity/classes/IFlashbangProjectile.h"
...
private:
    ...
    CFlashbangProjectile* Real() const { return static_cast<CFlashbangProjectile*>(m_pReal); }

public:
    CFlashbangProjectile* GetOriginal() const override { return Real(); }
