...
#ifndef _INCLUDE_RELATIONSHIP_TIMPL_H
#define _INCLUDE_RELATIONSHIP_TIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IRelationship_t.h"
#include "schema/entity/classes/Relationship_t.h"

class Relationship_tImpl : public virtual IRelationship_t
{
...
public:
    explicit Relationship_tImpl(void* p) : m_pReal(p) {}

private:
    Relationship_t* Real() { return static_cast<Relationship_t*>(m_pReal); }
    Relationship_t* Real() const { return static_cast<Relationship_t*>(m_pReal); }
