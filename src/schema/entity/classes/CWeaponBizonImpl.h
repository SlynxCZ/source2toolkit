...
#ifndef _INCLUDE_CWEAPONBIZONIMPL_H
#define _INCLUDE_CWEAPONBIZONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponBizon.h"
...
public:
    explicit CWeaponBizonImpl(CWeaponBizon* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponBizon* Real() { return static_cast<CWeaponBizon*>(m_pReal); }
    CWeaponBizon* Real() const { return static_cast<CWeaponBizon*>(m_pReal); }
