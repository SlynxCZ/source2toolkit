...
#ifndef _INCLUDE_CWEAPONREVOLVERIMPL_H
#define _INCLUDE_CWEAPONREVOLVERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponRevolver.h"
...
public:
    explicit CWeaponRevolverImpl(CWeaponRevolver* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponRevolver* Real() { return static_cast<CWeaponRevolver*>(m_pReal); }
    CWeaponRevolver* Real() const { return static_cast<CWeaponRevolver*>(m_pReal); }
