...
#ifndef _INCLUDE_CFILTERPROXIMITYIMPL_H
#define _INCLUDE_CFILTERPROXIMITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFilterProximity.h"
...
public:
    explicit CFilterProximityImpl(CFilterProximity* p) : CBaseFilterImpl(p) {}

private:
    CFilterProximity* Real() { return static_cast<CFilterProximity*>(m_pReal); }
    CFilterProximity* Real() const { return static_cast<CFilterProximity*>(m_pReal); }

public:
    CFilterProximity* GetOriginal() const override { return Real(); }
