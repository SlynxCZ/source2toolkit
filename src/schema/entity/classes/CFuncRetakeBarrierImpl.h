...
#ifndef _INCLUDE_CFUNCRETAKEBARRIERIMPL_H
#define _INCLUDE_CFUNCRETAKEBARRIERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncRetakeBarrier.h"
...
public:
    explicit CFuncRetakeBarrierImpl(CFuncRetakeBarrier* p) : CDynamicPropImpl(p) {}

private:
    CFuncRetakeBarrier* Real() { return static_cast<CFuncRetakeBarrier*>(m_pReal); }
    CFuncRetakeBarrier* Real() const { return static_cast<CFuncRetakeBarrier*>(m_pReal); }
