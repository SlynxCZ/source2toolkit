...
#include "source2toolkit/schema/entity/classes/ITriggerSndSosOpvar.h"
...
private:
    ...
    CTriggerSndSosOpvar* Real() const { return static_cast<CTriggerSndSosOpvar*>(m_pReal); }

public:
    CTriggerSndSosOpvar* GetOriginal() const override { return Real(); }
