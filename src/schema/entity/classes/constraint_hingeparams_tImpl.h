...
#ifndef _INCLUDE_CONSTRAINT_HINGEPARAMS_TIMPL_H
#define _INCLUDE_CONSTRAINT_HINGEPARAMS_TIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/Iconstraint_hingeparams_t.h"
#include "schema/entity/classes/constraint_hingeparams_t.h"

class constraint_hingeparams_tImpl : public virtual Iconstraint_hingeparams_t
{
...
public:
    explicit constraint_hingeparams_tImpl(void* p) : m_pReal(p) {}

private:
    constraint_hingeparams_t* Real() { return static_cast<constraint_hingeparams_t*>(m_pReal); }
    constraint_hingeparams_t* Real() const { return static_cast<constraint_hingeparams_t*>(m_pReal); }

public:
    constraint_hingeparams_t* GetOriginal() const override { return Real(); }
    Vector& WorldPosition() override { return Real()->worldPosition(); }
