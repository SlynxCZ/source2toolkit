...
#ifndef _INCLUDE_CPLAYER_WATERSERVICESIMPL_H
#define _INCLUDE_CPLAYER_WATERSERVICESIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPlayer_WaterServices.h"
...
public:
    explicit CPlayer_WaterServicesImpl(CPlayer_WaterServices* p) : CPlayerPawnComponentImpl(p) {}

private:
    CPlayer_WaterServices* Real() { return static_cast<CPlayer_WaterServices*>(m_pReal); }
    CPlayer_WaterServices* Real() const { return static_cast<CPlayer_WaterServices*>(m_pReal); }

public:
    CPlayer_WaterServices* GetOriginal() const override { return Real(); }
};
