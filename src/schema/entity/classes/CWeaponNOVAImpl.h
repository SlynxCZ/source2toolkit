...
#ifndef _INCLUDE_CWEAPONNOVAIMPL_H
#define _INCLUDE_CWEAPONNOVAIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponNOVA.h"
...
public:
    explicit CWeaponNOVAImpl(CWeaponNOVA* p) : CCSWeaponBaseShotgunImpl(p) {}

private:
    CWeaponNOVA* Real() { return static_cast<CWeaponNOVA*>(m_pReal); }
    CWeaponNOVA* Real() const { return static_cast<CWeaponNOVA*>(m_pReal); }
