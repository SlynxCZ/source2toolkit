...
#ifndef _INCLUDE_CPRECIPITATIONIMPL_H
#define _INCLUDE_CPRECIPITATIONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPrecipitation.h"
...
public:
    explicit CPrecipitationImpl(CPrecipitation* p) : CBaseTriggerImpl(p) {}

private:
    CPrecipitation* Real() { return static_cast<CPrecipitation*>(m_pReal); }
    CPrecipitation* Real() const { return static_cast<CPrecipitation*>(m_pReal); }
