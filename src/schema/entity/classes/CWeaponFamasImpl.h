...
#ifndef _INCLUDE_CWEAPONFAMASIMPL_H
#define _INCLUDE_CWEAPONFAMASIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponFamas.h"
...
public:
    explicit CWeaponFamasImpl(CWeaponFamas* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponFamas* Real() { return static_cast<CWeaponFamas*>(m_pReal); }
    CWeaponFamas* Real() const { return static_cast<CWeaponFamas*>(m_pReal); }
