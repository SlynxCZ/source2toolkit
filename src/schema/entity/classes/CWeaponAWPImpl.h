...
#ifndef _INCLUDE_CWEAPONAWPIMPL_H
#define _INCLUDE_CWEAPONAWPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponAWP.h"
...
public:
    explicit CWeaponAWPImpl(CWeaponAWP* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponAWP* Real() { return static_cast<CWeaponAWP*>(m_pReal); }
    CWeaponAWP* Real() const { return static_cast<CWeaponAWP*>(m_pReal); }
