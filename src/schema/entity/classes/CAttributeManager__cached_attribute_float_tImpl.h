...
#include "source2toolkit/schema/entity/classes/IAttributeManager__cached_attribute_float_t.h"
...
private:
    ...
    CAttributeManager__cached_attribute_float_t* Real() const { return static_cast<CAttributeManager__cached_attribute_float_t*>(m_pReal); }

public:
    CAttributeManager__cached_attribute_float_t* GetOriginal() const override { return Real(); }
