...
#ifndef _INCLUDE_CINFOTARGETSERVERONLYIMPL_H
#define _INCLUDE_CINFOTARGETSERVERONLYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoTargetServerOnly.h"
...
public:
    explicit CInfoTargetServerOnlyImpl(CInfoTargetServerOnly* p) : CServerOnlyPointEntityImpl(p) {}

private:
    CInfoTargetServerOnly* Real() { return static_cast<CInfoTargetServerOnly*>(m_pReal); }
    CInfoTargetServerOnly* Real() const { return static_cast<CInfoTargetServerOnly*>(m_pReal); }
