...
private:
    ...
    CDynamicNavConnectionsVolume* Real() const { return static_cast<CDynamicNavConnectionsVolume*>(m_pReal); }

public:
    CDynamicNavConnectionsVolume* GetOriginal() const override { return Real(); }
