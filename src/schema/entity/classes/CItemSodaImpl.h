...
#ifndef _INCLUDE_CITEMSODAIMPL_H
#define _INCLUDE_CITEMSODAIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IItemSoda.h"
...
public:
    explicit CItemSodaImpl(CItemSoda* p) : CBaseAnimGraphImpl(p) {}

private:
    CItemSoda* Real() { return static_cast<CItemSoda*>(m_pReal); }
    CItemSoda* Real() const { return static_cast<CItemSoda*>(m_pReal); }
