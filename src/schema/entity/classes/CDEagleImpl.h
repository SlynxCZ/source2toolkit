...
#ifndef _INCLUDE_CDEAGLEIMPL_H
#define _INCLUDE_CDEAGLEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IDEagle.h"
...
public:
    explicit CDEagleImpl(CDEagle* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CDEagle* Real() { return static_cast<CDEagle*>(m_pReal); }
    CDEagle* Real() const { return static_cast<CDEagle*>(m_pReal); }
