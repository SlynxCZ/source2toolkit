...
#include "source2toolkit/schema/entity/classes/ICSPlayer_RadioServices.h"
...
private:
    ...
    CCSPlayer_RadioServices* Real() const { return static_cast<CCSPlayer_RadioServices*>(m_pReal); }

public:
    CCSPlayer_RadioServices* GetOriginal() const override { return Real(); }
