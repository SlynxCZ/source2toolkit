...
#ifndef _INCLUDE_CFUNCVEHICLECLIPIMPL_H
#define _INCLUDE_CFUNCVEHICLECLIPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncVehicleClip.h"
...
public:
    explicit CFuncVehicleClipImpl(CFuncVehicleClip* p) : CBaseModelEntityImpl(p) {}

private:
    CFuncVehicleClip* Real() { return static_cast<CFuncVehicleClip*>(m_pReal); }
    CFuncVehicleClip* Real() const { return static_cast<CFuncVehicleClip*>(m_pReal); }
