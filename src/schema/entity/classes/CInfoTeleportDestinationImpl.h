...
#ifndef _INCLUDE_CINFOTELEPORTDESTINATIONIMPL_H
#define _INCLUDE_CINFOTELEPORTDESTINATIONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoTeleportDestination.h"
...
public:
    explicit CInfoTeleportDestinationImpl(CInfoTeleportDestination* p) : CPointEntityImpl(p) {}

private:
    CInfoTeleportDestination* Real() { return static_cast<CInfoTeleportDestination*>(m_pReal); }
    CInfoTeleportDestination* Real() const { return static_cast<CInfoTeleportDestination*>(m_pReal); }
