...
#ifndef _INCLUDE_CWEAPONMP5SDIMPL_H
#define _INCLUDE_CWEAPONMP5SDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponMP5SD.h"
...
public:
    explicit CWeaponMP5SDImpl(CWeaponMP5SD* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponMP5SD* Real() { return static_cast<CWeaponMP5SD*>(m_pReal); }
    CWeaponMP5SD* Real() const { return static_cast<CWeaponMP5SD*>(m_pReal); }
