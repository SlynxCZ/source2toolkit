...
#ifndef _INCLUDE_CCSOBSERVERPAWNIMPL_H
#define _INCLUDE_CCSOBSERVERPAWNIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSObserverPawn.h"
...
public:
    explicit CCSObserverPawnImpl(CCSObserverPawn* p) : CCSPlayerPawnBaseImpl(p) {}

private:
    CCSObserverPawn* Real() { return static_cast<CCSObserverPawn*>(m_pReal); }
    CCSObserverPawn* Real() const { return static_cast<CCSObserverPawn*>(m_pReal); }
