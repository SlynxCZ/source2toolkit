...
#ifndef _INCLUDE_CFUNCILLUSIONARYIMPL_H
#define _INCLUDE_CFUNCILLUSIONARYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncIllusionary.h"
...
public:
    explicit CFuncIllusionaryImpl(CFuncIllusionary* p) : CBaseModelEntityImpl(p) {}

private:
    CFuncIllusionary* Real() { return static_cast<CFuncIllusionary*>(m_pReal); }
    CFuncIllusionary* Real() const { return static_cast<CFuncIllusionary*>(m_pReal); }
