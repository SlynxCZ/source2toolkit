...
#ifndef _INCLUDE_CNULLENTITYIMPL_H
#define _INCLUDE_CNULLENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/INullEntity.h"
...
public:
    explicit CNullEntityImpl(CNullEntity* p) : CBaseEntityImpl(p) {}

private:
    CNullEntity* Real() { return static_cast<CNullEntity*>(m_pReal); }
    CNullEntity* Real() const { return static_cast<CNullEntity*>(m_pReal); }
