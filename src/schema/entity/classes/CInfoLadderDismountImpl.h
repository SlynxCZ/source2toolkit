...
#ifndef _INCLUDE_CINFOLADDERDISMOUNTIMPL_H
#define _INCLUDE_CINFOLADDERDISMOUNTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoLadderDismount.h"
...
public:
    explicit CInfoLadderDismountImpl(CInfoLadderDismount* p) : CBaseEntityImpl(p) {}

private:
    CInfoLadderDismount* Real() { return static_cast<CInfoLadderDismount*>(m_pReal); }
    CInfoLadderDismount* Real() const { return static_cast<CInfoLadderDismount*>(m_pReal); }
