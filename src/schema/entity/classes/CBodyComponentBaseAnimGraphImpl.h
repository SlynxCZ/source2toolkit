...
#ifndef _INCLUDE_CBODYCOMPONENTBASEANIMGRAPHIMPL_H
#define _INCLUDE_CBODYCOMPONENTBASEANIMGRAPHIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IBodyComponentBaseAnimGraph.h"
...
public:
    explicit CBodyComponentBaseAnimGraphImpl(CBodyComponentBaseAnimGraph* p) : CBodyComponentSkeletonInstanceImpl(p) {}

private:
    CBodyComponentBaseAnimGraph* Real() { return static_cast<CBodyComponentBaseAnimGraph*>(m_pReal); }
    CBodyComponentBaseAnimGraph* Real() const { return static_cast<CBodyComponentBaseAnimGraph*>(m_pReal); }
