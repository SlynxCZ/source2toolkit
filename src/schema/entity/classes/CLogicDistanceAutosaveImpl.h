...
#include "source2toolkit/schema/entity/classes/ILogicDistanceAutosave.h"
...
private:
    ...
    CLogicDistanceAutosave* Real() const { return static_cast<CLogicDistanceAutosave*>(m_pReal); }

public:
    CLogicDistanceAutosave* GetOriginal() const override { return Real(); }
