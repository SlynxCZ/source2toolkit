...
#include "source2toolkit/schema/entity/classes/ITonemapController2.h"
...
private:
    ...
    CTonemapController2* Real() const { return static_cast<CTonemapController2*>(m_pReal); }

public:
    CTonemapController2* GetOriginal() const override { return Real(); }
