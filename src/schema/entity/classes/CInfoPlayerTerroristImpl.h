...
#ifndef _INCLUDE_CINFOPLAYERTERRORISTIMPL_H
#define _INCLUDE_CINFOPLAYERTERRORISTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoPlayerTerrorist.h"
...
public:
    explicit CInfoPlayerTerroristImpl(CInfoPlayerTerrorist* p) : SpawnPointImpl(p) {}

private:
    CInfoPlayerTerrorist* Real() { return static_cast<CInfoPlayerTerrorist*>(m_pReal); }
    CInfoPlayerTerrorist* Real() const { return static_cast<CInfoPlayerTerrorist*>(m_pReal); }
