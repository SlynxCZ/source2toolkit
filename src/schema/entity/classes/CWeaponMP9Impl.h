...
#ifndef _INCLUDE_CWEAPONMP9IMPL_H
#define _INCLUDE_CWEAPONMP9IMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponMP9.h"
...
public:
    explicit CWeaponMP9Impl(CWeaponMP9* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponMP9* Real() { return static_cast<CWeaponMP9*>(m_pReal); }
    CWeaponMP9* Real() const { return static_cast<CWeaponMP9*>(m_pReal); }
