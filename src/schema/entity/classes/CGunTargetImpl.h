...
#ifndef _INCLUDE_CGUNTARGETIMPL_H
#define _INCLUDE_CGUNTARGETIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IGunTarget.h"
...
public:
    explicit CGunTargetImpl(CGunTarget* p) : CBaseToggleImpl(p) {}

private:
    CGunTarget* Real() { return static_cast<CGunTarget*>(m_pReal); }
    CGunTarget* Real() const { return static_cast<CGunTarget*>(m_pReal); }

public:
    CGunTarget* GetOriginal() const override { return Real(); }
