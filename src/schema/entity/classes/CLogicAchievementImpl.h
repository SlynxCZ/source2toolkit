...
#ifndef _INCLUDE_CLOGICACHIEVEMENTIMPL_H
#define _INCLUDE_CLOGICACHIEVEMENTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ILogicAchievement.h"
...
public:
    explicit CLogicAchievementImpl(CLogicAchievement* p) : CLogicalEntityImpl(p) {}

private:
    CLogicAchievement* Real() { return static_cast<CLogicAchievement*>(m_pReal); }
    CLogicAchievement* Real() const { return static_cast<CLogicAchievement*>(m_pReal); }

public:
    CLogicAchievement* GetOriginal() const override { return Real(); }
