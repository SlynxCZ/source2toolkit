...
#ifndef _INCLUDE_CWEAPONMAG7IMPL_H
#define _INCLUDE_CWEAPONMAG7IMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponMag7.h"
...
public:
    explicit CWeaponMag7Impl(CWeaponMag7* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponMag7* Real() { return static_cast<CWeaponMag7*>(m_pReal); }
    CWeaponMag7* Real() const { return static_cast<CWeaponMag7*>(m_pReal); }
