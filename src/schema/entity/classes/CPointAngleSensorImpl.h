...
#include "source2toolkit/schema/entity/classes/IPointAngleSensor.h"
...
private:
    ...
    CPointAngleSensor* Real() const { return static_cast<CPointAngleSensor*>(m_pReal); }

public:
    CPointAngleSensor* GetOriginal() const override { return Real(); }
