...
#ifndef _INCLUDE_CENVHUDHINTIMPL_H
#define _INCLUDE_CENVHUDHINTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IEnvHudHint.h"
...
public:
    explicit CEnvHudHintImpl(CEnvHudHint* p) : CPointEntityImpl(p) {}

private:
    CEnvHudHint* Real() { return static_cast<CEnvHudHint*>(m_pReal); }
    CEnvHudHint* Real() const { return static_cast<CEnvHudHint*>(m_pReal); }

public:
    CEnvHudHint* GetOriginal() const override { return Real(); }
