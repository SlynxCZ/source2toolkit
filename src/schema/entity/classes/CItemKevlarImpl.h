...
#ifndef _INCLUDE_CITEMKEVLARIMPL_H
#define _INCLUDE_CITEMKEVLARIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IItemKevlar.h"
...
public:
    explicit CItemKevlarImpl(CItemKevlar* p) : CItemImpl(p) {}

private:
    CItemKevlar* Real() { return static_cast<CItemKevlar*>(m_pReal); }
    CItemKevlar* Real() const { return static_cast<CItemKevlar*>(m_pReal); }
