...
private:
    ...
    CPointClientUIWorldPanel* Real() const { return static_cast<CPointClientUIWorldPanel*>(m_pReal); }

public:
    CPointClientUIWorldPanel* GetOriginal() const override { return Real(); }
