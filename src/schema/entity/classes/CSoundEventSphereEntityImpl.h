...
#ifndef _INCLUDE_CSOUNDEVENTSPHEREENTITYIMPL_H
#define _INCLUDE_CSOUNDEVENTSPHEREENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ISoundEventSphereEntity.h"
...
public:
    explicit CSoundEventSphereEntityImpl(CSoundEventSphereEntity* p) : CSoundEventEntityImpl(p) {}

private:
    CSoundEventSphereEntity* Real() { return static_cast<CSoundEventSphereEntity*>(m_pReal); }
    CSoundEventSphereEntity* Real() const { return static_cast<CSoundEventSphereEntity*>(m_pReal); }

public:
    CSoundEventSphereEntity* GetOriginal() const override { return Real(); }
