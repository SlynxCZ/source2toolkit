...
#ifndef _INCLUDE_CCSWEAPONBASESHOTGUNIMPL_H
#define _INCLUDE_CCSWEAPONBASESHOTGUNIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSWeaponBaseShotgun.h"
...
public:
    explicit CCSWeaponBaseShotgunImpl(CCSWeaponBaseShotgun* p) : CCSWeaponBaseImpl(p) {}

private:
    CCSWeaponBaseShotgun* Real() { return static_cast<CCSWeaponBaseShotgun*>(m_pReal); }
    CCSWeaponBaseShotgun* Real() const { return static_cast<CCSWeaponBaseShotgun*>(m_pReal); }
