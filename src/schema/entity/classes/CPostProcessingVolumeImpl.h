...
#include "source2toolkit/schema/entity/classes/IPostProcessingVolume.h"
...
private:
    ...
    CPostProcessingVolume* Real() const { return static_cast<CPostProcessingVolume*>(m_pReal); }

public:
    CPostProcessingVolume* GetOriginal() const override { return Real(); }
