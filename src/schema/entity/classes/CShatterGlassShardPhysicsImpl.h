...
#ifndef _INCLUDE_CSHATTERGLASSSHARDPHYSICSIMPL_H
#define _INCLUDE_CSHATTERGLASSSHARDPHYSICSIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IShatterGlassShardPhysics.h"
...
public:
    explicit CShatterGlassShardPhysicsImpl(CShatterGlassShardPhysics* p) : CPhysicsPropImpl(p) {}

private:
    CShatterGlassShardPhysics* Real() { return static_cast<CShatterGlassShardPhysics*>(m_pReal); }
    CShatterGlassShardPhysics* Real() const { return static_cast<CShatterGlassShardPhysics*>(m_pReal); }

public:
    CShatterGlassShardPhysics* GetOriginal() const override { return Real(); }
    bool& Debris() override { return Real()->m_bDebris(); }
