...
private:
    ...
    CEnvVolumetricFogController* Real() const { return static_cast<CEnvVolumetricFogController*>(m_pReal); }

public:
    CEnvVolumetricFogController* GetOriginal() const override { return Real(); }
