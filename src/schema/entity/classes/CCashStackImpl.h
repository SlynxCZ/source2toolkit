...
#ifndef _INCLUDE_CCASHSTACKIMPL_H
#define _INCLUDE_CCASHSTACKIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICashStack.h"
...
public:
    explicit CCashStackImpl(CCashStack* p) : CBaseModelEntityImpl(p) {}

private:
    CCashStack* Real() { return static_cast<CCashStack*>(m_pReal); }
    CCashStack* Real() const { return static_cast<CCashStack*>(m_pReal); }

public:
    CCashStack* GetOriginal() const override { return Real(); }
    int32_t& CashStackValue() override { return Real()->m_nCashStackValue(); }
