...
#ifndef _INCLUDE_CSPRITEORIENTEDIMPL_H
#define _INCLUDE_CSPRITEORIENTEDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ISpriteOriented.h"
...
public:
    explicit CSpriteOrientedImpl(CSpriteOriented* p) : CSpriteImpl(p) {}

private:
    CSpriteOriented* Real() { return static_cast<CSpriteOriented*>(m_pReal); }
    CSpriteOriented* Real() const { return static_cast<CSpriteOriented*>(m_pReal); }
