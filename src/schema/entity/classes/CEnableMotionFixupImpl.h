...
#ifndef _INCLUDE_CENABLEMOTIONFIXUPIMPL_H
#define _INCLUDE_CENABLEMOTIONFIXUPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IEnableMotionFixup.h"
...
public:
    explicit CEnableMotionFixupImpl(CEnableMotionFixup* p) : CBaseEntityImpl(p) {}

private:
    CEnableMotionFixup* Real() { return static_cast<CEnableMotionFixup*>(m_pReal); }
    CEnableMotionFixup* Real() const { return static_cast<CEnableMotionFixup*>(m_pReal); }
