...
#ifndef _INCLUDE_CINFOSPAWNGROUPLANDMARKIMPL_H
#define _INCLUDE_CINFOSPAWNGROUPLANDMARKIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoSpawnGroupLandmark.h"
...
public:
    explicit CInfoSpawnGroupLandmarkImpl(CInfoSpawnGroupLandmark* p) : CPointEntityImpl(p) {}

private:
    CInfoSpawnGroupLandmark* Real() { return static_cast<CInfoSpawnGroupLandmark*>(m_pReal); }
    CInfoSpawnGroupLandmark* Real() const { return static_cast<CInfoSpawnGroupLandmark*>(m_pReal); }
