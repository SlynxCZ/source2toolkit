...
#include "source2toolkit/schema/entity/classes/IFuncTrackTrain.h"
...
private:
    ...
    CFuncTrackTrain* Real() const { return static_cast<CFuncTrackTrain*>(m_pReal); }

public:
    CFuncTrackTrain* GetOriginal() const override { return Real(); }
