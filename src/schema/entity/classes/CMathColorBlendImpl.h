...
#include "source2toolkit/schema/entity/classes/IMathColorBlend.h"
...
private:
    ...
    CMathColorBlend* Real() const { return static_cast<CMathColorBlend*>(m_pReal); }

public:
    CMathColorBlend* GetOriginal() const override { return Real(); }
