...
#ifndef _INCLUDE_CCSGO_TEAMSELECTCHARACTERPOSITIONIMPL_H
#define _INCLUDE_CCSGO_TEAMSELECTCHARACTERPOSITIONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSGO_TeamSelectCharacterPosition.h"
...
public:
    explicit CCSGO_TeamSelectCharacterPositionImpl(CCSGO_TeamSelectCharacterPosition* p) : CCSGO_TeamPreviewCharacterPositionImpl(p) {}

private:
    CCSGO_TeamSelectCharacterPosition* Real() { return static_cast<CCSGO_TeamSelectCharacterPosition*>(m_pReal); }
    CCSGO_TeamSelectCharacterPosition* Real() const { return static_cast<CCSGO_TeamSelectCharacterPosition*>(m_pReal); }
