...
#ifndef _INCLUDE_CHOSTAGERESCUEZONEIMPL_H
#define _INCLUDE_CHOSTAGERESCUEZONEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IHostageRescueZone.h"
...
public:
    explicit CHostageRescueZoneImpl(CHostageRescueZone* p) : CHostageRescueZoneShimImpl(p) {}

private:
    CHostageRescueZone* Real() { return static_cast<CHostageRescueZone*>(m_pReal); }
    CHostageRescueZone* Real() const { return static_cast<CHostageRescueZone*>(m_pReal); }
