...
#ifndef _INCLUDE_CSERVERONLYMODELENTITYIMPL_H
#define _INCLUDE_CSERVERONLYMODELENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IServerOnlyModelEntity.h"
...
public:
    explicit CServerOnlyModelEntityImpl(CServerOnlyModelEntity* p) : CBaseModelEntityImpl(p) {}

private:
    CServerOnlyModelEntity* Real() { return static_cast<CServerOnlyModelEntity*>(m_pReal); }
    CServerOnlyModelEntity* Real() const { return static_cast<CServerOnlyModelEntity*>(m_pReal); }
