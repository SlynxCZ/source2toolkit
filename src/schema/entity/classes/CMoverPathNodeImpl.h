...
#ifndef _INCLUDE_CMOVERPATHNODEIMPL_H
#define _INCLUDE_CMOVERPATHNODEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IMoverPathNode.h"
...
public:
    explicit CMoverPathNodeImpl(CMoverPathNode* p) : CPathNodeImpl(p) {}

private:
    CMoverPathNode* Real() { return static_cast<CMoverPathNode*>(m_pReal); }
    CMoverPathNode* Real() const { return static_cast<CMoverPathNode*>(m_pReal); }
