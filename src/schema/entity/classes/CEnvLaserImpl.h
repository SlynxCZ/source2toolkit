...
#include "source2toolkit/schema/entity/classes/IEnvLaser.h"
...
private:
    ...
    CEnvLaser* Real() const { return static_cast<CEnvLaser*>(m_pReal); }

public:
    CEnvLaser* GetOriginal() const override { return Real(); }
