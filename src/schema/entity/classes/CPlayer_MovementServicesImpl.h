...
#include "source2toolkit/schema/entity/classes/IPlayer_MovementServices.h"
...
private:
    ...
    CPlayer_MovementServices* Real() const { return static_cast<CPlayer_MovementServices*>(m_pReal); }
