...
#ifndef _INCLUDE_CWEAPONNEGEVIMPL_H
#define _INCLUDE_CWEAPONNEGEVIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponNegev.h"
...
public:
    explicit CWeaponNegevImpl(CWeaponNegev* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponNegev* Real() { return static_cast<CWeaponNegev*>(m_pReal); }
    CWeaponNegev* Real() const { return static_cast<CWeaponNegev*>(m_pReal); }
