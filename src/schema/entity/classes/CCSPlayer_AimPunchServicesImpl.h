...
private:
    ...
    CCSPlayer_AimPunchServices* Real() const { return static_cast<CCSPlayer_AimPunchServices*>(m_pReal); }

public:
    CCSPlayer_AimPunchServices* GetOriginal() const override { return Real(); }
