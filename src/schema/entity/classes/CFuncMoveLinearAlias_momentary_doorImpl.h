...
#ifndef _INCLUDE_CFUNCMOVELINEARALIAS_MOMENTARY_DOORIMPL_H
#define _INCLUDE_CFUNCMOVELINEARALIAS_MOMENTARY_DOORIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncMoveLinearAlias_momentary_door.h"
...
public:
    explicit CFuncMoveLinearAlias_momentary_doorImpl(CFuncMoveLinearAlias_momentary_door* p) : CFuncMoveLinearImpl(p) {}

private:
    CFuncMoveLinearAlias_momentary_door* Real() { return static_cast<CFuncMoveLinearAlias_momentary_door*>(m_pReal); }
    CFuncMoveLinearAlias_momentary_door* Real() const { return static_cast<CFuncMoveLinearAlias_momentary_door*>(m_pReal); }
