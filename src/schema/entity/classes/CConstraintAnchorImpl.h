...
#ifndef _INCLUDE_CCONSTRAINTANCHORIMPL_H
#define _INCLUDE_CCONSTRAINTANCHORIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IConstraintAnchor.h"
...
public:
    explicit CConstraintAnchorImpl(CConstraintAnchor* p) : CBaseAnimGraphImpl(p) {}

private:
    CConstraintAnchor* Real() { return static_cast<CConstraintAnchor*>(m_pReal); }
    CConstraintAnchor* Real() const { return static_cast<CConstraintAnchor*>(m_pReal); }

public:
    CConstraintAnchor* GetOriginal() const override { return Real(); }
