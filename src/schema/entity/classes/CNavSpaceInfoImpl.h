...
#ifndef _INCLUDE_CNAVSPACEINFOIMPL_H
#define _INCLUDE_CNAVSPACEINFOIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/INavSpaceInfo.h"
...
public:
    explicit CNavSpaceInfoImpl(CNavSpaceInfo* p) : CPointEntityImpl(p) {}

private:
    CNavSpaceInfo* Real() { return static_cast<CNavSpaceInfo*>(m_pReal); }
    CNavSpaceInfo* Real() const { return static_cast<CNavSpaceInfo*>(m_pReal); }
