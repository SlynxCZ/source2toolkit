...
#ifndef _INCLUDE_CITEMDEFUSERIMPL_H
#define _INCLUDE_CITEMDEFUSERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IItemDefuser.h"
...
public:
    explicit CItemDefuserImpl(CItemDefuser* p) : CItemImpl(p) {}

private:
    CItemDefuser* Real() { return static_cast<CItemDefuser*>(m_pReal); }
    CItemDefuser* Real() const { return static_cast<CItemDefuser*>(m_pReal); }
