...
#ifndef _INCLUDE_CSOUNDEVENTENTITYALIAS_SND_EVENT_POINTIMPL_H
#define _INCLUDE_CSOUNDEVENTENTITYALIAS_SND_EVENT_POINTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ISoundEventEntityAlias_snd_event_point.h"
...
public:
    explicit CSoundEventEntityAlias_snd_event_pointImpl(CSoundEventEntityAlias_snd_event_point* p) : CSoundEventEntityImpl(p) {}

private:
    CSoundEventEntityAlias_snd_event_point* Real() { return static_cast<CSoundEventEntityAlias_snd_event_point*>(m_pReal); }
    CSoundEventEntityAlias_snd_event_point* Real() const { return static_cast<CSoundEventEntityAlias_snd_event_point*>(m_pReal); }
