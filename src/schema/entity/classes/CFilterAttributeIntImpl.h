...
#ifndef _INCLUDE_CFILTERATTRIBUTEINTIMPL_H
#define _INCLUDE_CFILTERATTRIBUTEINTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFilterAttributeInt.h"
...
public:
    explicit CFilterAttributeIntImpl(CFilterAttributeInt* p) : CBaseFilterImpl(p) {}

private:
    CFilterAttributeInt* Real() { return static_cast<CFilterAttributeInt*>(m_pReal); }
    CFilterAttributeInt* Real() const { return static_cast<CFilterAttributeInt*>(m_pReal); }

public:
    CFilterAttributeInt* GetOriginal() const override { return Real(); }
    CUtlSymbolLarge& AttributeName() override { return Real()->m_sAttributeName(); }
