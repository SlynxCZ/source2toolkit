...
#include "source2toolkit/schema/entity/classes/IFuncTimescale.h"
...
private:
    ...
    CFuncTimescale* Real() const { return static_cast<CFuncTimescale*>(m_pReal); }

public:
    CFuncTimescale* GetOriginal() const override { return Real(); }
