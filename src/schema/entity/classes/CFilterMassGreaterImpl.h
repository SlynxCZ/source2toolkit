...
#ifndef _INCLUDE_CFILTERMASSGREATERIMPL_H
#define _INCLUDE_CFILTERMASSGREATERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFilterMassGreater.h"
...
public:
    explicit CFilterMassGreaterImpl(CFilterMassGreater* p) : CBaseFilterImpl(p) {}

private:
    CFilterMassGreater* Real() { return static_cast<CFilterMassGreater*>(m_pReal); }
    CFilterMassGreater* Real() const { return static_cast<CFilterMassGreater*>(m_pReal); }

public:
    CFilterMassGreater* GetOriginal() const override { return Real(); }
    float& FilterMass() override { return Real()->m_fFilterMass(); }
