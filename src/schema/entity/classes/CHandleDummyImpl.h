...
#ifndef _INCLUDE_CHANDLEDUMMYIMPL_H
#define _INCLUDE_CHANDLEDUMMYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IHandleDummy.h"
...
public:
    explicit CHandleDummyImpl(CHandleDummy* p) : CBaseEntityImpl(p) {}

private:
    CHandleDummy* Real() { return static_cast<CHandleDummy*>(m_pReal); }
    CHandleDummy* Real() const { return static_cast<CHandleDummy*>(m_pReal); }
