...
#ifndef _INCLUDE_CRULEPOINTENTITYIMPL_H
#define _INCLUDE_CRULEPOINTENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IRulePointEntity.h"
...
public:
    explicit CRulePointEntityImpl(CRulePointEntity* p) : CRuleEntityImpl(p) {}

private:
    CRulePointEntity* Real() { return static_cast<CRulePointEntity*>(m_pReal); }
    CRulePointEntity* Real() const { return static_cast<CRulePointEntity*>(m_pReal); }

public:
    CRulePointEntity* GetOriginal() const override { return Real(); }
    int32_t& Score() override { return Real()->m_Score(); }
