...
#ifndef _INCLUDE_CMARKUPVOLUMETAGGED_NAVIMPL_H
#define _INCLUDE_CMARKUPVOLUMETAGGED_NAVIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IMarkupVolumeTagged_Nav.h"
...
public:
    explicit CMarkupVolumeTagged_NavImpl(CMarkupVolumeTagged_Nav* p) : CMarkupVolumeTaggedImpl(p) {}

private:
    CMarkupVolumeTagged_Nav* Real() { return static_cast<CMarkupVolumeTagged_Nav*>(m_pReal); }
    CMarkupVolumeTagged_Nav* Real() const { return static_cast<CMarkupVolumeTagged_Nav*>(m_pReal); }
