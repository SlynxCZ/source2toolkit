...
#ifndef _INCLUDE_CSERVERONLYPOINTENTITYIMPL_H
#define _INCLUDE_CSERVERONLYPOINTENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IServerOnlyPointEntity.h"
...
public:
    explicit CServerOnlyPointEntityImpl(CServerOnlyPointEntity* p) : CServerOnlyEntityImpl(p) {}

private:
    CServerOnlyPointEntity* Real() { return static_cast<CServerOnlyPointEntity*>(m_pReal); }
    CServerOnlyPointEntity* Real() const { return static_cast<CServerOnlyPointEntity*>(m_pReal); }
