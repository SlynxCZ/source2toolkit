...
#ifndef _INCLUDE_CFILTERMULTIPLEIMPL_H
#define _INCLUDE_CFILTERMULTIPLEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFilterMultiple.h"
...
public:
    explicit CFilterMultipleImpl(CFilterMultiple* p) : CBaseFilterImpl(p) {}

private:
    CFilterMultiple* Real() { return static_cast<CFilterMultiple*>(m_pReal); }
    CFilterMultiple* Real() const { return static_cast<CFilterMultiple*>(m_pReal); }
