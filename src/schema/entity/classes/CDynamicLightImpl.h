...
#include "source2toolkit/schema/entity/classes/IDynamicLight.h"
...
private:
    ...
    CDynamicLight* Real() const { return static_cast<CDynamicLight*>(m_pReal); }

public:
    CDynamicLight* GetOriginal() const override { return Real(); }
