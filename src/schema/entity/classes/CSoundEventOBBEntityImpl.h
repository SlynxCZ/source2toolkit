...
#ifndef _INCLUDE_CSOUNDEVENTOBBENTITYIMPL_H
#define _INCLUDE_CSOUNDEVENTOBBENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ISoundEventOBBEntity.h"
...
public:
    explicit CSoundEventOBBEntityImpl(CSoundEventOBBEntity* p) : CSoundEventEntityImpl(p) {}

private:
    CSoundEventOBBEntity* Real() { return static_cast<CSoundEventOBBEntity*>(m_pReal); }
    CSoundEventOBBEntity* Real() const { return static_cast<CSoundEventOBBEntity*>(m_pReal); }

public:
    CSoundEventOBBEntity* GetOriginal() const override { return Real(); }
