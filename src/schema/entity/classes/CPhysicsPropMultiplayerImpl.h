...
#ifndef _INCLUDE_CPHYSICSPROPMULTIPLAYERIMPL_H
#define _INCLUDE_CPHYSICSPROPMULTIPLAYERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPhysicsPropMultiplayer.h"
...
public:
    explicit CPhysicsPropMultiplayerImpl(CPhysicsPropMultiplayer* p) : CPhysicsPropImpl(p) {}

private:
    CPhysicsPropMultiplayer* Real() { return static_cast<CPhysicsPropMultiplayer*>(m_pReal); }
    CPhysicsPropMultiplayer* Real() const { return static_cast<CPhysicsPropMultiplayer*>(m_pReal); }
