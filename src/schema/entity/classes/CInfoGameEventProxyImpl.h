...
#ifndef _INCLUDE_CINFOGAMEEVENTPROXYIMPL_H
#define _INCLUDE_CINFOGAMEEVENTPROXYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoGameEventProxy.h"
...
public:
    explicit CInfoGameEventProxyImpl(CInfoGameEventProxy* p) : CPointEntityImpl(p) {}

private:
    CInfoGameEventProxy* Real() { return static_cast<CInfoGameEventProxy*>(m_pReal); }
    CInfoGameEventProxy* Real() const { return static_cast<CInfoGameEventProxy*>(m_pReal); }

public:
    CInfoGameEventProxy* GetOriginal() const override { return Real(); }
    CUtlSymbolLarge& EventName() override { return Real()->m_iszEventName(); }
