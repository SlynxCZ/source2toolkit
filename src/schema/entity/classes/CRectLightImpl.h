...
#ifndef _INCLUDE_CRECTLIGHTIMPL_H
#define _INCLUDE_CRECTLIGHTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IRectLight.h"
...
public:
    explicit CRectLightImpl(CRectLight* p) : CBarnLightImpl(p) {}

private:
    CRectLight* Real() { return static_cast<CRectLight*>(m_pReal); }
    CRectLight* Real() const { return static_cast<CRectLight*>(m_pReal); }

public:
    CRectLight* GetOriginal() const override { return Real(); }
