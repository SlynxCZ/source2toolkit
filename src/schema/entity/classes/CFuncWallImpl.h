...
#ifndef _INCLUDE_CFUNCWALLIMPL_H
#define _INCLUDE_CFUNCWALLIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncWall.h"
...
public:
    explicit CFuncWallImpl(CFuncWall* p) : CBaseModelEntityImpl(p) {}

private:
    CFuncWall* Real() { return static_cast<CFuncWall*>(m_pReal); }
    CFuncWall* Real() const { return static_cast<CFuncWall*>(m_pReal); }

public:
    CFuncWall* GetOriginal() const override { return Real(); }
