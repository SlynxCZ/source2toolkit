...
private:
    ...
    CCSPlayerController_InGameMoneyServices* Real() const { return static_cast<CCSPlayerController_InGameMoneyServices*>(m_pReal); }

public:
    CCSPlayerController_InGameMoneyServices* GetOriginal() const override { return Real(); }
