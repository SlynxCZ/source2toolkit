...
#ifndef _INCLUDE_CCSOBSERVER_OBSERVERSERVICESIMPL_H
#define _INCLUDE_CCSOBSERVER_OBSERVERSERVICESIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSObserver_ObserverServices.h"
...
public:
    explicit CCSObserver_ObserverServicesImpl(CCSObserver_ObserverServices* p) : CPlayer_ObserverServicesImpl(p) {}

private:
    CCSObserver_ObserverServices* Real() { return static_cast<CCSObserver_ObserverServices*>(m_pReal); }
    CCSObserver_ObserverServices* Real() const { return static_cast<CCSObserver_ObserverServices*>(m_pReal); }

public:
    CCSObserver_ObserverServices* GetOriginal() const override { return Real(); }
};
