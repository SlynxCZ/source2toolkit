...
#include "source2toolkit/schema/entity/classes/IEnvEntityMaker.h"
...
private:
    ...
    CEnvEntityMaker* Real() const { return static_cast<CEnvEntityMaker*>(m_pReal); }

public:
    CEnvEntityMaker* GetOriginal() const override { return Real(); }
