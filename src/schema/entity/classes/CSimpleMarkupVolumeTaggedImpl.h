...
#ifndef _INCLUDE_CSIMPLEMARKUPVOLUMETAGGEDIMPL_H
#define _INCLUDE_CSIMPLEMARKUPVOLUMETAGGEDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ISimpleMarkupVolumeTagged.h"
...
public:
    explicit CSimpleMarkupVolumeTaggedImpl(CSimpleMarkupVolumeTagged* p) : CMarkupVolumeTaggedImpl(p) {}

private:
    CSimpleMarkupVolumeTagged* Real() { return static_cast<CSimpleMarkupVolumeTagged*>(m_pReal); }
    CSimpleMarkupVolumeTagged* Real() const { return static_cast<CSimpleMarkupVolumeTagged*>(m_pReal); }
