...
#ifndef _INCLUDE_CENVSOUNDSCAPEPROXYIMPL_H
#define _INCLUDE_CENVSOUNDSCAPEPROXYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IEnvSoundscapeProxy.h"
...
public:
    explicit CEnvSoundscapeProxyImpl(CEnvSoundscapeProxy* p) : CEnvSoundscapeImpl(p) {}

private:
    CEnvSoundscapeProxy* Real() { return static_cast<CEnvSoundscapeProxy*>(m_pReal); }
    CEnvSoundscapeProxy* Real() const { return static_cast<CEnvSoundscapeProxy*>(m_pReal); }

public:
    CEnvSoundscapeProxy* GetOriginal() const override { return Real(); }
    CUtlSymbolLarge& MainSoundscapeName() override { return Real()->m_MainSoundscapeName(); }
