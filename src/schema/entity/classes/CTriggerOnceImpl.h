...
#ifndef _INCLUDE_CTRIGGERONCEIMPL_H
#define _INCLUDE_CTRIGGERONCEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerOnce.h"
...
public:
    explicit CTriggerOnceImpl(CTriggerOnce* p) : CTriggerMultipleImpl(p) {}

private:
    CTriggerOnce* Real() { return static_cast<CTriggerOnce*>(m_pReal); }
    CTriggerOnce* Real() const { return static_cast<CTriggerOnce*>(m_pReal); }
