...
#ifndef _INCLUDE_CPOINTSERVERCOMMANDIMPL_H
#define _INCLUDE_CPOINTSERVERCOMMANDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPointServerCommand.h"
...
public:
    explicit CPointServerCommandImpl(CPointServerCommand* p) : CPointEntityImpl(p) {}

private:
    CPointServerCommand* Real() { return static_cast<CPointServerCommand*>(m_pReal); }
    CPointServerCommand* Real() const { return static_cast<CPointServerCommand*>(m_pReal); }
