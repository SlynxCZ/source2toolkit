...
#ifndef _INCLUDE_CWEAPONFIVESEVENIMPL_H
#define _INCLUDE_CWEAPONFIVESEVENIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponFiveSeven.h"
...
public:
    explicit CWeaponFiveSevenImpl(CWeaponFiveSeven* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponFiveSeven* Real() { return static_cast<CWeaponFiveSeven*>(m_pReal); }
    CWeaponFiveSeven* Real() const { return static_cast<CWeaponFiveSeven*>(m_pReal); }
