...
#include "source2toolkit/schema/entity/classes/ICS2PawnGraphController.h"
...
private:
    ...
    CCS2PawnGraphController* Real() const { return static_cast<CCS2PawnGraphController*>(m_pReal); }

public:
    CCS2PawnGraphController* GetOriginal() const override { return Real(); }
};
