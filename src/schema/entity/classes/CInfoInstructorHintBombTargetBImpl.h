...
#ifndef _INCLUDE_CINFOINSTRUCTORHINTBOMBTARGETBIMPL_H
#define _INCLUDE_CINFOINSTRUCTORHINTBOMBTARGETBIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoInstructorHintBombTargetB.h"
...
public:
    explicit CInfoInstructorHintBombTargetBImpl(CInfoInstructorHintBombTargetB* p) : CPointEntityImpl(p) {}

private:
    CInfoInstructorHintBombTargetB* Real() { return static_cast<CInfoInstructorHintBombTargetB*>(m_pReal); }
    CInfoInstructorHintBombTargetB* Real() const { return static_cast<CInfoInstructorHintBombTargetB*>(m_pReal); }
