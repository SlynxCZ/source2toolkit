...
#include "source2toolkit/schema/entity/classes/INavHullVData.h"
...
private:
    ...
    CNavHullVData* Real() const { return static_cast<CNavHullVData*>(m_pReal); }

public:
    CNavHullVData* GetOriginal() const override { return Real(); }
