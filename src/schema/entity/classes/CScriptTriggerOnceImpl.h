...
#ifndef _INCLUDE_CSCRIPTTRIGGERONCEIMPL_H
#define _INCLUDE_CSCRIPTTRIGGERONCEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IScriptTriggerOnce.h"
...
public:
    explicit CScriptTriggerOnceImpl(CScriptTriggerOnce* p) : CTriggerOnceImpl(p) {}

private:
    CScriptTriggerOnce* Real() { return static_cast<CScriptTriggerOnce*>(m_pReal); }
    CScriptTriggerOnce* Real() const { return static_cast<CScriptTriggerOnce*>(m_pReal); }

public:
    CScriptTriggerOnce* GetOriginal() const override { return Real(); }
