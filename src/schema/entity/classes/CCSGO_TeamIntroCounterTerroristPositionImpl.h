...
#ifndef _INCLUDE_CCSGO_TEAMINTROCOUNTERTERRORISTPOSITIONIMPL_H
#define _INCLUDE_CCSGO_TEAMINTROCOUNTERTERRORISTPOSITIONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSGO_TeamIntroCounterTerroristPosition.h"
...
public:
    explicit CCSGO_TeamIntroCounterTerroristPositionImpl(CCSGO_TeamIntroCounterTerroristPosition* p) : CCSGO_TeamIntroCharacterPositionImpl(p) {}

private:
    CCSGO_TeamIntroCounterTerroristPosition* Real() { return static_cast<CCSGO_TeamIntroCounterTerroristPosition*>(m_pReal); }
    CCSGO_TeamIntroCounterTerroristPosition* Real() const { return static_cast<CCSGO_TeamIntroCounterTerroristPosition*>(m_pReal); }
