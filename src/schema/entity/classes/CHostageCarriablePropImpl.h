...
#ifndef _INCLUDE_CHOSTAGECARRIABLEPROPIMPL_H
#define _INCLUDE_CHOSTAGECARRIABLEPROPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IHostageCarriableProp.h"
...
public:
    explicit CHostageCarriablePropImpl(CHostageCarriableProp* p) : CBaseAnimGraphImpl(p) {}

private:
    CHostageCarriableProp* Real() { return static_cast<CHostageCarriableProp*>(m_pReal); }
    CHostageCarriableProp* Real() const { return static_cast<CHostageCarriableProp*>(m_pReal); }
