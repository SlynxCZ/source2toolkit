...
#ifndef _INCLUDE_CTRIGGERMULTIPLEIMPL_H
#define _INCLUDE_CTRIGGERMULTIPLEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerMultiple.h"
...
public:
    explicit CTriggerMultipleImpl(CTriggerMultiple* p) : CBaseTriggerImpl(p) {}

private:
    CTriggerMultiple* Real() { return static_cast<CTriggerMultiple*>(m_pReal); }
    CTriggerMultiple* Real() const { return static_cast<CTriggerMultiple*>(m_pReal); }
