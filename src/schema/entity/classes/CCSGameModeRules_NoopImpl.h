...
#ifndef _INCLUDE_CCSGAMEMODERULES_NOOPIMPL_H
#define _INCLUDE_CCSGAMEMODERULES_NOOPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSGameModeRules_Noop.h"
...
public:
    explicit CCSGameModeRules_NoopImpl(CCSGameModeRules_Noop* p) : CCSGameModeRulesImpl(p) {}

private:
    CCSGameModeRules_Noop* Real() { return static_cast<CCSGameModeRules_Noop*>(m_pReal); }
    CCSGameModeRules_Noop* Real() const { return static_cast<CCSGameModeRules_Noop*>(m_pReal); }

public:
    CCSGameModeRules_Noop* GetOriginal() const override { return Real(); }
};
