...
#include "source2toolkit/schema/entity/classes/IPhysicsEntitySolver.h"
...
private:
    ...
    CPhysicsEntitySolver* Real() const { return static_cast<CPhysicsEntitySolver*>(m_pReal); }

public:
    CPhysicsEntitySolver* GetOriginal() const override { return Real(); }
