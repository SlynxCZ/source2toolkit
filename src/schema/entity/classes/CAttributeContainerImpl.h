...
#ifndef _INCLUDE_CATTRIBUTECONTAINERIMPL_H
#define _INCLUDE_CATTRIBUTECONTAINERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IAttributeContainer.h"
...
public:
    explicit CAttributeContainerImpl(CAttributeContainer* p) : CAttributeManagerImpl(p) {}

private:
    CAttributeContainer* Real() { return static_cast<CAttributeContainer*>(m_pReal); }
    CAttributeContainer* Real() const { return static_cast<CAttributeContainer*>(m_pReal); }
