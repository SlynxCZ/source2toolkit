...
private:
    ...
    CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable* Real() const { return static_cast<CEnvSoundscapeTriggerableAlias_snd_soundscape_triggerable*>(m_pReal); }
