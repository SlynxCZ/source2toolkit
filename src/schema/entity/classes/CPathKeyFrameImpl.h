...
#include "source2toolkit/schema/entity/classes/IPathKeyFrame.h"
...
private:
    ...
    CPathKeyFrame* Real() const { return static_cast<CPathKeyFrame*>(m_pReal); }

public:
    CPathKeyFrame* GetOriginal() const override { return Real(); }
