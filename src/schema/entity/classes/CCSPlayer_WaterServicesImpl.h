...
#include "source2toolkit/schema/entity/classes/ICSPlayer_WaterServices.h"
...
private:
    ...
    CCSPlayer_WaterServices* Real() const { return static_cast<CCSPlayer_WaterServices*>(m_pReal); }

public:
    CCSPlayer_WaterServices* GetOriginal() const override { return Real(); }
