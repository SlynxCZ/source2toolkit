...
#ifndef _INCLUDE_CCOMMENTARYVIEWPOSITIONIMPL_H
#define _INCLUDE_CCOMMENTARYVIEWPOSITIONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICommentaryViewPosition.h"
...
public:
    explicit CCommentaryViewPositionImpl(CCommentaryViewPosition* p) : CSpriteImpl(p) {}

private:
    CCommentaryViewPosition* Real() { return static_cast<CCommentaryViewPosition*>(m_pReal); }
    CCommentaryViewPosition* Real() const { return static_cast<CCommentaryViewPosition*>(m_pReal); }
