...
#ifndef _INCLUDE_CFOGTRIGGERIMPL_H
#define _INCLUDE_CFOGTRIGGERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFogTrigger.h"
...
public:
    explicit CFogTriggerImpl(CFogTrigger* p) : CBaseTriggerImpl(p) {}

private:
    CFogTrigger* Real() { return static_cast<CFogTrigger*>(m_pReal); }
    CFogTrigger* Real() const { return static_cast<CFogTrigger*>(m_pReal); }
