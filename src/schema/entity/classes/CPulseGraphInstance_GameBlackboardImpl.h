...
#ifndef _INCLUDE_CPULSEGRAPHINSTANCE_GAMEBLACKBOARDIMPL_H
#define _INCLUDE_CPULSEGRAPHINSTANCE_GAMEBLACKBOARDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPulseGraphInstance_GameBlackboard.h"
...
public:
    explicit CPulseGraphInstance_GameBlackboardImpl(CPulseGraphInstance_GameBlackboard* p) : CPulseGraphInstance_ServerEntityImpl(p) {}

private:
    CPulseGraphInstance_GameBlackboard* Real() { return static_cast<CPulseGraphInstance_GameBlackboard*>(m_pReal); }
    CPulseGraphInstance_GameBlackboard* Real() const { return static_cast<CPulseGraphInstance_GameBlackboard*>(m_pReal); }

public:
    CPulseGraphInstance_GameBlackboard* GetOriginal() const override { return Real(); }
};
