...
#ifndef _INCLUDE_CWEAPONP250IMPL_H
#define _INCLUDE_CWEAPONP250IMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponP250.h"
...
public:
    explicit CWeaponP250Impl(CWeaponP250* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponP250* Real() { return static_cast<CWeaponP250*>(m_pReal); }
    CWeaponP250* Real() const { return static_cast<CWeaponP250*>(m_pReal); }
