...
#ifndef _INCLUDE_CSMOKEGRENADEIMPL_H
#define _INCLUDE_CSMOKEGRENADEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ISmokeGrenade.h"
...
public:
    explicit CSmokeGrenadeImpl(CSmokeGrenade* p) : CBaseCSGrenadeImpl(p) {}

private:
    CSmokeGrenade* Real() { return static_cast<CSmokeGrenade*>(m_pReal); }
    CSmokeGrenade* Real() const { return static_cast<CSmokeGrenade*>(m_pReal); }
