...
#ifndef _INCLUDE_CFUNCLADDERALIAS_FUNC_USEABLELADDERIMPL_H
#define _INCLUDE_CFUNCLADDERALIAS_FUNC_USEABLELADDERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncLadderAlias_func_useableladder.h"
...
public:
    explicit CFuncLadderAlias_func_useableladderImpl(CFuncLadderAlias_func_useableladder* p) : CFuncLadderImpl(p) {}

private:
    CFuncLadderAlias_func_useableladder* Real() { return static_cast<CFuncLadderAlias_func_useableladder*>(m_pReal); }
    CFuncLadderAlias_func_useableladder* Real() const { return static_cast<CFuncLadderAlias_func_useableladder*>(m_pReal); }
