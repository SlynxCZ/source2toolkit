...
#ifndef _INCLUDE_CPOINTCLIENTUIWORLDTEXTPANELIMPL_H
#define _INCLUDE_CPOINTCLIENTUIWORLDTEXTPANELIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPointClientUIWorldTextPanel.h"
...
public:
    explicit CPointClientUIWorldTextPanelImpl(CPointClientUIWorldTextPanel* p) : CPointClientUIWorldPanelImpl(p) {}

private:
    CPointClientUIWorldTextPanel* Real() { return static_cast<CPointClientUIWorldTextPanel*>(m_pReal); }
    CPointClientUIWorldTextPanel* Real() const { return static_cast<CPointClientUIWorldTextPanel*>(m_pReal); }

public:
    CPointClientUIWorldTextPanel* GetOriginal() const override { return Real(); }
