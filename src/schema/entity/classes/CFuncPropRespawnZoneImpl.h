...
#ifndef _INCLUDE_CFUNCPROPRESPAWNZONEIMPL_H
#define _INCLUDE_CFUNCPROPRESPAWNZONEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncPropRespawnZone.h"
...
public:
    explicit CFuncPropRespawnZoneImpl(CFuncPropRespawnZone* p) : CBaseEntityImpl(p) {}

private:
    CFuncPropRespawnZone* Real() { return static_cast<CFuncPropRespawnZone*>(m_pReal); }
    CFuncPropRespawnZone* Real() const { return static_cast<CFuncPropRespawnZone*>(m_pReal); }
