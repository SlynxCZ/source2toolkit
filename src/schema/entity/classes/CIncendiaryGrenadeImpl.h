...
#ifndef _INCLUDE_CINCENDIARYGRENADEIMPL_H
#define _INCLUDE_CINCENDIARYGRENADEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IIncendiaryGrenade.h"
...
public:
    explicit CIncendiaryGrenadeImpl(CIncendiaryGrenade* p) : CMolotovGrenadeImpl(p) {}

private:
    CIncendiaryGrenade* Real() { return static_cast<CIncendiaryGrenade*>(m_pReal); }
    CIncendiaryGrenade* Real() const { return static_cast<CIncendiaryGrenade*>(m_pReal); }
