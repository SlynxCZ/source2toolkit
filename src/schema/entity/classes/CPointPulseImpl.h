...
#ifndef _INCLUDE_CPOINTPULSEIMPL_H
#define _INCLUDE_CPOINTPULSEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPointPulse.h"
...
public:
    explicit CPointPulseImpl(CPointPulse* p) : CBaseEntityImpl(p) {}

private:
    CPointPulse* Real() { return static_cast<CPointPulse*>(m_pReal); }
    CPointPulse* Real() const { return static_cast<CPointPulse*>(m_pReal); }
