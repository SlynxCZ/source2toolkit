...
#ifndef _INCLUDE_CLIGHTENVIRONMENTENTITYIMPL_H
#define _INCLUDE_CLIGHTENVIRONMENTENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ILightEnvironmentEntity.h"
...
public:
    explicit CLightEnvironmentEntityImpl(CLightEnvironmentEntity* p) : CLightDirectionalEntityImpl(p) {}

private:
    CLightEnvironmentEntity* Real() { return static_cast<CLightEnvironmentEntity*>(m_pReal); }
    CLightEnvironmentEntity* Real() const { return static_cast<CLightEnvironmentEntity*>(m_pReal); }
