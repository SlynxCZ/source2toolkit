...
#ifndef _INCLUDE_CENVSOUNDSCAPETRIGGERABLEIMPL_H
#define _INCLUDE_CENVSOUNDSCAPETRIGGERABLEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IEnvSoundscapeTriggerable.h"
...
public:
    explicit CEnvSoundscapeTriggerableImpl(CEnvSoundscapeTriggerable* p) : CEnvSoundscapeImpl(p) {}

private:
    CEnvSoundscapeTriggerable* Real() { return static_cast<CEnvSoundscapeTriggerable*>(m_pReal); }
    CEnvSoundscapeTriggerable* Real() const { return static_cast<CEnvSoundscapeTriggerable*>(m_pReal); }
