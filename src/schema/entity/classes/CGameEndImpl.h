...
#ifndef _INCLUDE_CGAMEENDIMPL_H
#define _INCLUDE_CGAMEENDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IGameEnd.h"
...
public:
    explicit CGameEndImpl(CGameEnd* p) : CRulePointEntityImpl(p) {}

private:
    CGameEnd* Real() { return static_cast<CGameEnd*>(m_pReal); }
    CGameEnd* Real() const { return static_cast<CGameEnd*>(m_pReal); }
