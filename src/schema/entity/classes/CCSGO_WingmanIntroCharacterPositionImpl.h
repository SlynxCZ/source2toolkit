...
#ifndef _INCLUDE_CCSGO_WINGMANINTROCHARACTERPOSITIONIMPL_H
#define _INCLUDE_CCSGO_WINGMANINTROCHARACTERPOSITIONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSGO_WingmanIntroCharacterPosition.h"
...
public:
    explicit CCSGO_WingmanIntroCharacterPositionImpl(CCSGO_WingmanIntroCharacterPosition* p) : CCSGO_TeamIntroCharacterPositionImpl(p) {}

private:
    CCSGO_WingmanIntroCharacterPosition* Real() { return static_cast<CCSGO_WingmanIntroCharacterPosition*>(m_pReal); }
    CCSGO_WingmanIntroCharacterPosition* Real() const { return static_cast<CCSGO_WingmanIntroCharacterPosition*>(m_pReal); }
