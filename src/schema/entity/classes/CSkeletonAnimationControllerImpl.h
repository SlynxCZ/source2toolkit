...
#ifndef _INCLUDE_CSKELETONANIMATIONCONTROLLERIMPL_H
#define _INCLUDE_CSKELETONANIMATIONCONTROLLERIMPL_H
...
public:
    explicit CSkeletonAnimationControllerImpl(CSkeletonAnimationController* p) : ISkeletonAnimationControllerImpl(p) {}

private:
    CSkeletonAnimationController* Real() { return static_cast<CSkeletonAnimationController*>(m_pReal); }
    CSkeletonAnimationController* Real() const { return static_cast<CSkeletonAnimationController*>(m_pReal); }

public:
    CSkeletonAnimationController* GetOriginal() const override { return Real(); }
    CSkeletonInstance*& SkeletonInstance() override { return Real()->m_pSkeletonInstance(); }
    void SkeletonInstanceUpdated() override { Real()->m_pSkeletonInstance.NetworkStateChanged(); }
};
