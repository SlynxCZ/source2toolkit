...
#ifndef _INCLUDE_CBODYCOMPONENTPOINTIMPL_H
#define _INCLUDE_CBODYCOMPONENTPOINTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IBodyComponentPoint.h"
...
public:
    explicit CBodyComponentPointImpl(CBodyComponentPoint* p) : CBodyComponentImpl(p) {}

private:
    CBodyComponentPoint* Real() { return static_cast<CBodyComponentPoint*>(m_pReal); }
    CBodyComponentPoint* Real() const { return static_cast<CBodyComponentPoint*>(m_pReal); }
