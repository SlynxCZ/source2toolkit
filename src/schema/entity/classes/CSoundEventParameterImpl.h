...
#include "source2toolkit/schema/entity/classes/ISoundEventParameter.h"
...
private:
    ...
    CSoundEventParameter* Real() const { return static_cast<CSoundEventParameter*>(m_pReal); }

public:
    CSoundEventParameter* GetOriginal() const override { return Real(); }
