...
#ifndef _INCLUDE_CTRIGGERGRAVITYIMPL_H
#define _INCLUDE_CTRIGGERGRAVITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerGravity.h"
...
public:
    explicit CTriggerGravityImpl(CTriggerGravity* p) : CBaseTriggerImpl(p) {}

private:
    CTriggerGravity* Real() { return static_cast<CTriggerGravity*>(m_pReal); }
    CTriggerGravity* Real() const { return static_cast<CTriggerGravity*>(m_pReal); }
