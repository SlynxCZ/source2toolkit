...
#ifndef _INCLUDE_CSCRIPTTRIGGERPUSHIMPL_H
#define _INCLUDE_CSCRIPTTRIGGERPUSHIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IScriptTriggerPush.h"
...
public:
    explicit CScriptTriggerPushImpl(CScriptTriggerPush* p) : CTriggerPushImpl(p) {}

private:
    CScriptTriggerPush* Real() { return static_cast<CScriptTriggerPush*>(m_pReal); }
    CScriptTriggerPush* Real() const { return static_cast<CScriptTriggerPush*>(m_pReal); }

public:
    CScriptTriggerPush* GetOriginal() const override { return Real(); }
