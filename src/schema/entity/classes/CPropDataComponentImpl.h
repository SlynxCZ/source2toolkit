...
#include "source2toolkit/schema/entity/classes/IPropDataComponent.h"
...
private:
    ...
    CPropDataComponent* Real() const { return static_cast<CPropDataComponent*>(m_pReal); }

public:
    CPropDataComponent* GetOriginal() const override { return Real(); }
