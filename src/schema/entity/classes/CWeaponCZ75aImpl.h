...
#ifndef _INCLUDE_CWEAPONCZ75AIMPL_H
#define _INCLUDE_CWEAPONCZ75AIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponCZ75a.h"
...
public:
    explicit CWeaponCZ75aImpl(CWeaponCZ75a* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponCZ75a* Real() { return static_cast<CWeaponCZ75a*>(m_pReal); }
    CWeaponCZ75a* Real() const { return static_cast<CWeaponCZ75a*>(m_pReal); }

public:
    CWeaponCZ75a* GetOriginal() const override { return Real(); }
    bool& MagazineRemoved() override { return Real()->m_bMagazineRemoved(); }
