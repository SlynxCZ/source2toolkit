...
#include "source2toolkit/schema/entity/classes/IAI_ChangeHintGroup.h"
...
private:
    ...
    CAI_ChangeHintGroup* Real() const { return static_cast<CAI_ChangeHintGroup*>(m_pReal); }

public:
    CAI_ChangeHintGroup* GetOriginal() const override { return Real(); }
