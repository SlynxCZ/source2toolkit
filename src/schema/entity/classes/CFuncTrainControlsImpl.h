...
#ifndef _INCLUDE_CFUNCTRAINCONTROLSIMPL_H
#define _INCLUDE_CFUNCTRAINCONTROLSIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncTrainControls.h"
...
public:
    explicit CFuncTrainControlsImpl(CFuncTrainControls* p) : CBaseModelEntityImpl(p) {}

private:
    CFuncTrainControls* Real() { return static_cast<CFuncTrainControls*>(m_pReal); }
    CFuncTrainControls* Real() const { return static_cast<CFuncTrainControls*>(m_pReal); }
