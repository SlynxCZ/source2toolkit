...
#include "source2toolkit/schema/entity/classes/IRagdollManager.h"
...
private:
    ...
    CRagdollManager* Real() const { return static_cast<CRagdollManager*>(m_pReal); }

public:
    CRagdollManager* GetOriginal() const override { return Real(); }
