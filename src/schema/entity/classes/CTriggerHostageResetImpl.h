...
#ifndef _INCLUDE_CTRIGGERHOSTAGERESETIMPL_H
#define _INCLUDE_CTRIGGERHOSTAGERESETIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerHostageReset.h"
...
public:
    explicit CTriggerHostageResetImpl(CTriggerHostageReset* p) : CBaseTriggerImpl(p) {}

private:
    CTriggerHostageReset* Real() { return static_cast<CTriggerHostageReset*>(m_pReal); }
    CTriggerHostageReset* Real() const { return static_cast<CTriggerHostageReset*>(m_pReal); }
