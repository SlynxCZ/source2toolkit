...
#ifndef _INCLUDE_CSOUNDSTACKSAVEIMPL_H
#define _INCLUDE_CSOUNDSTACKSAVEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ISoundStackSave.h"
...
public:
    explicit CSoundStackSaveImpl(CSoundStackSave* p) : CLogicalEntityImpl(p) {}

private:
    CSoundStackSave* Real() { return static_cast<CSoundStackSave*>(m_pReal); }
    CSoundStackSave* Real() const { return static_cast<CSoundStackSave*>(m_pReal); }

public:
    CSoundStackSave* GetOriginal() const override { return Real(); }
