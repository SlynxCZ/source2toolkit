...
private:
    ...
    CPropDoorRotatingBreakable* Real() const { return static_cast<CPropDoorRotatingBreakable*>(m_pReal); }

public:
    CPropDoorRotatingBreakable* GetOriginal() const override { return Real(); }
