...
#ifndef _INCLUDE_CINFODYNAMICSHADOWHINTBOXIMPL_H
#define _INCLUDE_CINFODYNAMICSHADOWHINTBOXIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoDynamicShadowHintBox.h"
...
public:
    explicit CInfoDynamicShadowHintBoxImpl(CInfoDynamicShadowHintBox* p) : CInfoDynamicShadowHintImpl(p) {}

private:
    CInfoDynamicShadowHintBox* Real() { return static_cast<CInfoDynamicShadowHintBox*>(m_pReal); }
    CInfoDynamicShadowHintBox* Real() const { return static_cast<CInfoDynamicShadowHintBox*>(m_pReal); }

public:
    CInfoDynamicShadowHintBox* GetOriginal() const override { return Real(); }
