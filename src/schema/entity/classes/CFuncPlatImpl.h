...
#ifndef _INCLUDE_CFUNCPLATIMPL_H
#define _INCLUDE_CFUNCPLATIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncPlat.h"
...
public:
    explicit CFuncPlatImpl(CFuncPlat* p) : CBasePlatTrainImpl(p) {}

private:
    CFuncPlat* Real() { return static_cast<CFuncPlat*>(m_pReal); }
    CFuncPlat* Real() const { return static_cast<CFuncPlat*>(m_pReal); }

public:
    CFuncPlat* GetOriginal() const override { return Real(); }
