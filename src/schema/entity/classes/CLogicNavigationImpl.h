...
#ifndef _INCLUDE_CLOGICNAVIGATIONIMPL_H
#define _INCLUDE_CLOGICNAVIGATIONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ILogicNavigation.h"
...
public:
    explicit CLogicNavigationImpl(CLogicNavigation* p) : CLogicalEntityImpl(p) {}

private:
    CLogicNavigation* Real() { return static_cast<CLogicNavigation*>(m_pReal); }
    CLogicNavigation* Real() const { return static_cast<CLogicNavigation*>(m_pReal); }
