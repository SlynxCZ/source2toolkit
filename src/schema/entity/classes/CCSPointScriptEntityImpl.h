...
#ifndef _INCLUDE_CCSPOINTSCRIPTENTITYIMPL_H
#define _INCLUDE_CCSPOINTSCRIPTENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSPointScriptEntity.h"
...
public:
    explicit CCSPointScriptEntityImpl(CCSPointScriptEntity* p) : CBaseEntityImpl(p) {}

private:
    CCSPointScriptEntity* Real() { return static_cast<CCSPointScriptEntity*>(m_pReal); }
    CCSPointScriptEntity* Real() const { return static_cast<CCSPointScriptEntity*>(m_pReal); }
