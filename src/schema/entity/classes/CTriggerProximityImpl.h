...
#ifndef _INCLUDE_CTRIGGERPROXIMITYIMPL_H
#define _INCLUDE_CTRIGGERPROXIMITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerProximity.h"
...
public:
    explicit CTriggerProximityImpl(CTriggerProximity* p) : CBaseTriggerImpl(p) {}

private:
    CTriggerProximity* Real() { return static_cast<CTriggerProximity*>(m_pReal); }
    CTriggerProximity* Real() const { return static_cast<CTriggerProximity*>(m_pReal); }
