...
#ifndef _INCLUDE_CINFOTARGETIMPL_H
#define _INCLUDE_CINFOTARGETIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoTarget.h"
...
public:
    explicit CInfoTargetImpl(CInfoTarget* p) : CPointEntityImpl(p) {}

private:
    CInfoTarget* Real() { return static_cast<CInfoTarget*>(m_pReal); }
    CInfoTarget* Real() const { return static_cast<CInfoTarget*>(m_pReal); }
