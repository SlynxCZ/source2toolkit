...
#ifndef _INCLUDE_CSCRIPTITEMIMPL_H
#define _INCLUDE_CSCRIPTITEMIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IScriptItem.h"
...
public:
    explicit CScriptItemImpl(CScriptItem* p) : CItemImpl(p) {}

private:
    CScriptItem* Real() { return static_cast<CScriptItem*>(m_pReal); }
    CScriptItem* Real() const { return static_cast<CScriptItem*>(m_pReal); }
