...
#ifndef _INCLUDE_CINFODATAIMPL_H
#define _INCLUDE_CINFODATAIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoData.h"
...
public:
    explicit CInfoDataImpl(CInfoData* p) : CServerOnlyEntityImpl(p) {}

private:
    CInfoData* Real() { return static_cast<CInfoData*>(m_pReal); }
    CInfoData* Real() const { return static_cast<CInfoData*>(m_pReal); }
