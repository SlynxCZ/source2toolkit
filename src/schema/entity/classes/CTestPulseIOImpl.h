...
#ifndef _INCLUDE_CTESTPULSEIOIMPL_H
#define _INCLUDE_CTESTPULSEIOIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITestPulseIO.h"
...
public:
    explicit CTestPulseIOImpl(CTestPulseIO* p) : CLogicalEntityImpl(p) {}

private:
    CTestPulseIO* Real() { return static_cast<CTestPulseIO*>(m_pReal); }
    CTestPulseIO* Real() const { return static_cast<CTestPulseIO*>(m_pReal); }
