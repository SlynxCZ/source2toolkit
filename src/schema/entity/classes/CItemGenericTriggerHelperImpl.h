...
private:
    ...
    CItemGenericTriggerHelper* Real() const { return static_cast<CItemGenericTriggerHelper*>(m_pReal); }

public:
    CItemGenericTriggerHelper* GetOriginal() const override { return Real(); }
