...
#include "source2toolkit/schema/entity/classes/IPlayer_ObserverServices.h"
...
private:
    ...
    CPlayer_ObserverServices* Real() const { return static_cast<CPlayer_ObserverServices*>(m_pReal); }

public:
    CPlayer_ObserverServices* GetOriginal() const override { return Real(); }
