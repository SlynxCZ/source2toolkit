...
#ifndef _INCLUDE_CPHYSTHRUSTERIMPL_H
#define _INCLUDE_CPHYSTHRUSTERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPhysThruster.h"
...
public:
    explicit CPhysThrusterImpl(CPhysThruster* p) : CPhysForceImpl(p) {}

private:
    CPhysThruster* Real() { return static_cast<CPhysThruster*>(m_pReal); }
    CPhysThruster* Real() const { return static_cast<CPhysThruster*>(m_pReal); }

public:
    CPhysThruster* GetOriginal() const override { return Real(); }
    Vector& LocalOrigin() override { return Real()->m_localOrigin(); }
