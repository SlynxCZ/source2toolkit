...
#ifndef _INCLUDE_CSERVERRAGDOLLTRIGGERIMPL_H
#define _INCLUDE_CSERVERRAGDOLLTRIGGERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IServerRagdollTrigger.h"
...
public:
    explicit CServerRagdollTriggerImpl(CServerRagdollTrigger* p) : CBaseTriggerImpl(p) {}

private:
    CServerRagdollTrigger* Real() { return static_cast<CServerRagdollTrigger*>(m_pReal); }
    CServerRagdollTrigger* Real() const { return static_cast<CServerRagdollTrigger*>(m_pReal); }
