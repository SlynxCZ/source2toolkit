...
#ifndef _INCLUDE_CWORLDIMPL_H
#define _INCLUDE_CWORLDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWorld.h"
...
public:
    explicit CWorldImpl(CWorld* p) : CBaseModelEntityImpl(p) {}

private:
    CWorld* Real() { return static_cast<CWorld*>(m_pReal); }
    CWorld* Real() const { return static_cast<CWorld*>(m_pReal); }
