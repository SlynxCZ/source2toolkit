...
#include "source2toolkit/schema/entity/classes/IPlayer_AutoaimServices.h"
...
private:
    ...
    CPlayer_AutoaimServices* Real() const { return static_cast<CPlayer_AutoaimServices*>(m_pReal); }

public:
    CPlayer_AutoaimServices* GetOriginal() const override { return Real(); }
};
