...
#include "source2toolkit/schema/entity/classes/ICSGO_TeamPreviewCharacterPosition.h"
...
private:
    ...
    CCSGO_TeamPreviewCharacterPosition* Real() const { return static_cast<CCSGO_TeamPreviewCharacterPosition*>(m_pReal); }

public:
    CCSGO_TeamPreviewCharacterPosition* GetOriginal() const override { return Real(); }
