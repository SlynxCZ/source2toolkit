...
#ifndef _INCLUDE_CINFOINSTRUCTORHINTHOSTAGERESCUEZONEIMPL_H
#define _INCLUDE_CINFOINSTRUCTORHINTHOSTAGERESCUEZONEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IInfoInstructorHintHostageRescueZone.h"
...
public:
    explicit CInfoInstructorHintHostageRescueZoneImpl(CInfoInstructorHintHostageRescueZone* p) : CPointEntityImpl(p) {}

private:
    CInfoInstructorHintHostageRescueZone* Real() { return static_cast<CInfoInstructorHintHostageRescueZone*>(m_pReal); }
    CInfoInstructorHintHostageRescueZone* Real() const { return static_cast<CInfoInstructorHintHostageRescueZone*>(m_pReal); }
