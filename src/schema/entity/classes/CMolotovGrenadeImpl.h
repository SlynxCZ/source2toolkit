...
#ifndef _INCLUDE_CMOLOTOVGRENADEIMPL_H
#define _INCLUDE_CMOLOTOVGRENADEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IMolotovGrenade.h"
...
public:
    explicit CMolotovGrenadeImpl(CMolotovGrenade* p) : CBaseCSGrenadeImpl(p) {}

private:
    CMolotovGrenade* Real() { return static_cast<CMolotovGrenade*>(m_pReal); }
    CMolotovGrenade* Real() const { return static_cast<CMolotovGrenade*>(m_pReal); }
