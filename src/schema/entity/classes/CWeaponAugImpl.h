...
#ifndef _INCLUDE_CWEAPONAUGIMPL_H
#define _INCLUDE_CWEAPONAUGIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponAug.h"
...
public:
    explicit CWeaponAugImpl(CWeaponAug* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponAug* Real() { return static_cast<CWeaponAug*>(m_pReal); }
    CWeaponAug* Real() const { return static_cast<CWeaponAug*>(m_pReal); }
