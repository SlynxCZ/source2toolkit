...
#ifndef _INCLUDE_CFUNCVPHYSICSCLIPIMPL_H
#define _INCLUDE_CFUNCVPHYSICSCLIPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFuncVPhysicsClip.h"
...
public:
    explicit CFuncVPhysicsClipImpl(CFuncVPhysicsClip* p) : CBaseModelEntityImpl(p) {}

private:
    CFuncVPhysicsClip* Real() { return static_cast<CFuncVPhysicsClip*>(m_pReal); }
    CFuncVPhysicsClip* Real() const { return static_cast<CFuncVPhysicsClip*>(m_pReal); }

public:
    CFuncVPhysicsClip* GetOriginal() const override { return Real(); }
