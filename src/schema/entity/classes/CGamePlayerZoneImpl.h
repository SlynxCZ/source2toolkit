...
#ifndef _INCLUDE_CGAMEPLAYERZONEIMPL_H
#define _INCLUDE_CGAMEPLAYERZONEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IGamePlayerZone.h"
...
public:
    explicit CGamePlayerZoneImpl(CGamePlayerZone* p) : CRuleBrushEntityImpl(p) {}

private:
    CGamePlayerZone* Real() { return static_cast<CGamePlayerZone*>(m_pReal); }
    CGamePlayerZone* Real() const { return static_cast<CGamePlayerZone*>(m_pReal); }
