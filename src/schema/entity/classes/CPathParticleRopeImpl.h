...
#include "source2toolkit/schema/entity/classes/IPathParticleRope.h"
...
private:
    ...
    CPathParticleRope* Real() const { return static_cast<CPathParticleRope*>(m_pReal); }

public:
    CPathParticleRope* GetOriginal() const override { return Real(); }
