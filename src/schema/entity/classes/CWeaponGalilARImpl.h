...
#ifndef _INCLUDE_CWEAPONGALILARIMPL_H
#define _INCLUDE_CWEAPONGALILARIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponGalilAR.h"
...
public:
    explicit CWeaponGalilARImpl(CWeaponGalilAR* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponGalilAR* Real() { return static_cast<CWeaponGalilAR*>(m_pReal); }
    CWeaponGalilAR* Real() const { return static_cast<CWeaponGalilAR*>(m_pReal); }
