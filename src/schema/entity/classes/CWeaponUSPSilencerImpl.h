...
#ifndef _INCLUDE_CWEAPONUSPSILENCERIMPL_H
#define _INCLUDE_CWEAPONUSPSILENCERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponUSPSilencer.h"
...
public:
    explicit CWeaponUSPSilencerImpl(CWeaponUSPSilencer* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponUSPSilencer* Real() { return static_cast<CWeaponUSPSilencer*>(m_pReal); }
    CWeaponUSPSilencer* Real() const { return static_cast<CWeaponUSPSilencer*>(m_pReal); }
