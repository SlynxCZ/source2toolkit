...
#ifndef _INCLUDE_CPHYSICALBUTTONIMPL_H
#define _INCLUDE_CPHYSICALBUTTONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPhysicalButton.h"
...
public:
    explicit CPhysicalButtonImpl(CPhysicalButton* p) : CBaseButtonImpl(p) {}

private:
    CPhysicalButton* Real() { return static_cast<CPhysicalButton*>(m_pReal); }
    CPhysicalButton* Real() const { return static_cast<CPhysicalButton*>(m_pReal); }
