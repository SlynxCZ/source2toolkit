...
private:
    ...
    CCSPlayerController_DamageServices* Real() const { return static_cast<CCSPlayerController_DamageServices*>(m_pReal); }

public:
    CCSPlayerController_DamageServices* GetOriginal() const override { return Real(); }
