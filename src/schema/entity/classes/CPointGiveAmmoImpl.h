...
#ifndef _INCLUDE_CPOINTGIVEAMMOIMPL_H
#define _INCLUDE_CPOINTGIVEAMMOIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPointGiveAmmo.h"
...
public:
    explicit CPointGiveAmmoImpl(CPointGiveAmmo* p) : CPointEntityImpl(p) {}

private:
    CPointGiveAmmo* Real() { return static_cast<CPointGiveAmmo*>(m_pReal); }
    CPointGiveAmmo* Real() const { return static_cast<CPointGiveAmmo*>(m_pReal); }

public:
    CPointGiveAmmo* GetOriginal() const override { return Real(); }
