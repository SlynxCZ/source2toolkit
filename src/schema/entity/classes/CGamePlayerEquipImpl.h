...
#ifndef _INCLUDE_CGAMEPLAYEREQUIPIMPL_H
#define _INCLUDE_CGAMEPLAYEREQUIPIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IGamePlayerEquip.h"
...
public:
    explicit CGamePlayerEquipImpl(CGamePlayerEquip* p) : CRulePointEntityImpl(p) {}

private:
    CGamePlayerEquip* Real() { return static_cast<CGamePlayerEquip*>(m_pReal); }
    CGamePlayerEquip* Real() const { return static_cast<CGamePlayerEquip*>(m_pReal); }
