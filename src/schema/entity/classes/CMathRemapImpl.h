...
#include "source2toolkit/schema/entity/classes/IMathRemap.h"
...
private:
    ...
    CMathRemap* Real() const { return static_cast<CMathRemap*>(m_pReal); }

public:
    CMathRemap* GetOriginal() const override { return Real(); }
