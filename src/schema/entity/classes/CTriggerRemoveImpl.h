...
#ifndef _INCLUDE_CTRIGGERREMOVEIMPL_H
#define _INCLUDE_CTRIGGERREMOVEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerRemove.h"
...
public:
    explicit CTriggerRemoveImpl(CTriggerRemove* p) : CBaseTriggerImpl(p) {}

private:
    CTriggerRemove* Real() { return static_cast<CTriggerRemove*>(m_pReal); }
    CTriggerRemove* Real() const { return static_cast<CTriggerRemove*>(m_pReal); }
