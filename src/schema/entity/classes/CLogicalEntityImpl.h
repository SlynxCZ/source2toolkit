...
#ifndef _INCLUDE_CLOGICALENTITYIMPL_H
#define _INCLUDE_CLOGICALENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ILogicalEntity.h"
...
public:
    explicit CLogicalEntityImpl(CLogicalEntity* p) : CServerOnlyEntityImpl(p) {}

private:
    CLogicalEntity* Real() { return static_cast<CLogicalEntity*>(m_pReal); }
    CLogicalEntity* Real() const { return static_cast<CLogicalEntity*>(m_pReal); }
