...
#ifndef _INCLUDE_CROTDOORIMPL_H
#define _INCLUDE_CROTDOORIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IRotDoor.h"
...
public:
    explicit CRotDoorImpl(CRotDoor* p) : CBaseDoorImpl(p) {}

private:
    CRotDoor* Real() { return static_cast<CRotDoor*>(m_pReal); }
    CRotDoor* Real() const { return static_cast<CRotDoor*>(m_pReal); }

public:
    CRotDoor* GetOriginal() const override { return Real(); }
