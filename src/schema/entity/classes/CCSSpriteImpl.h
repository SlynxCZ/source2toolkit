...
#ifndef _INCLUDE_CCSSPRITEIMPL_H
#define _INCLUDE_CCSSPRITEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSSprite.h"
...
public:
    explicit CCSSpriteImpl(CCSSprite* p) : CSpriteImpl(p) {}

private:
    CCSSprite* Real() { return static_cast<CCSSprite*>(m_pReal); }
    CCSSprite* Real() const { return static_cast<CCSSprite*>(m_pReal); }
