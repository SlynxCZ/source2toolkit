...
#ifndef _INCLUDE_CWEAPONGLOCKIMPL_H
#define _INCLUDE_CWEAPONGLOCKIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponGlock.h"
...
public:
    explicit CWeaponGlockImpl(CWeaponGlock* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponGlock* Real() { return static_cast<CWeaponGlock*>(m_pReal); }
    CWeaponGlock* Real() const { return static_cast<CWeaponGlock*>(m_pReal); }
