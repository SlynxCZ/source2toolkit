...
#include "source2toolkit/schema/entity/classes/ISoundOpvarSetEntity.h"
...
private:
    ...
    CSoundOpvarSetEntity* Real() const { return static_cast<CSoundOpvarSetEntity*>(m_pReal); }

public:
    CSoundOpvarSetEntity* GetOriginal() const override { return Real(); }
