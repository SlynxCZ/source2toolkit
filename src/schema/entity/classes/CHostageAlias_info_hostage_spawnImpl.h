...
#ifndef _INCLUDE_CHOSTAGEALIAS_INFO_HOSTAGE_SPAWNIMPL_H
#define _INCLUDE_CHOSTAGEALIAS_INFO_HOSTAGE_SPAWNIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IHostageAlias_info_hostage_spawn.h"
...
public:
    explicit CHostageAlias_info_hostage_spawnImpl(CHostageAlias_info_hostage_spawn* p) : CHostageImpl(p) {}

private:
    CHostageAlias_info_hostage_spawn* Real() { return static_cast<CHostageAlias_info_hostage_spawn*>(m_pReal); }
    CHostageAlias_info_hostage_spawn* Real() const { return static_cast<CHostageAlias_info_hostage_spawn*>(m_pReal); }
