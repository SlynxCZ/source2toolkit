...
#ifndef _INCLUDE_CFOGCONTROLLERIMPL_H
#define _INCLUDE_CFOGCONTROLLERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFogController.h"
...
public:
    explicit CFogControllerImpl(CFogController* p) : CBaseEntityImpl(p) {}

private:
    CFogController* Real() { return static_cast<CFogController*>(m_pReal); }
    CFogController* Real() const { return static_cast<CFogController*>(m_pReal); }
...
public:
    ...
    int32_t& ChangedVariables() override { return Real()->m_iChangedVariables(); }
