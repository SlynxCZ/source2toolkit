...
#include "source2toolkit/schema/entity/classes/IItemDogtags.h"
...
private:
    ...
    CItemDogtags* Real() const { return static_cast<CItemDogtags*>(m_pReal); }

public:
    CItemDogtags* GetOriginal() const override { return Real(); }
