...
#ifndef _INCLUDE_CMOVEMENTSTATSPROPERTYIMPL_H
#define _INCLUDE_CMOVEMENTSTATSPROPERTYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IMovementStatsProperty.h"
#include "schema/entity/classes/CMovementStatsProperty.h"

class CMovementStatsPropertyImpl : public virtual IMovementStatsProperty
{
...
public:
    explicit CMovementStatsPropertyImpl(void* p) : m_pReal(p) {}

private:
    CMovementStatsProperty* Real() { return static_cast<CMovementStatsProperty*>(m_pReal); }
    CMovementStatsProperty* Real() const { return static_cast<CMovementStatsProperty*>(m_pReal); }
