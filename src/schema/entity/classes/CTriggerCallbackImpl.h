...
#ifndef _INCLUDE_CTRIGGERCALLBACKIMPL_H
#define _INCLUDE_CTRIGGERCALLBACKIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerCallback.h"
...
public:
    explicit CTriggerCallbackImpl(CTriggerCallback* p) : CBaseTriggerImpl(p) {}

private:
    CTriggerCallback* Real() { return static_cast<CTriggerCallback*>(m_pReal); }
    CTriggerCallback* Real() const { return static_cast<CTriggerCallback*>(m_pReal); }
