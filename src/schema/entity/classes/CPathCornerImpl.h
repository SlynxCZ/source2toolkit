...
#ifndef _INCLUDE_CPATHCORNERIMPL_H
#define _INCLUDE_CPATHCORNERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPathCorner.h"
...
public:
    explicit CPathCornerImpl(CPathCorner* p) : CPointEntityImpl(p) {}

private:
    CPathCorner* Real() { return static_cast<CPathCorner*>(m_pReal); }
    CPathCorner* Real() const { return static_cast<CPathCorner*>(m_pReal); }

public:
    CPathCorner* GetOriginal() const override { return Real(); }
