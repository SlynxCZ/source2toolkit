...
#ifndef _INCLUDE_CROTBUTTONIMPL_H
#define _INCLUDE_CROTBUTTONIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IRotButton.h"
...
public:
    explicit CRotButtonImpl(CRotButton* p) : CBaseButtonImpl(p) {}

private:
    CRotButton* Real() { return static_cast<CRotButton*>(m_pReal); }
    CRotButton* Real() const { return static_cast<CRotButton*>(m_pReal); }
