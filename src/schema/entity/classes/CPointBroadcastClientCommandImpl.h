...
#ifndef _INCLUDE_CPOINTBROADCASTCLIENTCOMMANDIMPL_H
#define _INCLUDE_CPOINTBROADCASTCLIENTCOMMANDIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPointBroadcastClientCommand.h"
...
public:
    explicit CPointBroadcastClientCommandImpl(CPointBroadcastClientCommand* p) : CPointEntityImpl(p) {}

private:
    CPointBroadcastClientCommand* Real() { return static_cast<CPointBroadcastClientCommand*>(m_pReal); }
    CPointBroadcastClientCommand* Real() const { return static_cast<CPointBroadcastClientCommand*>(m_pReal); }
