...
#ifndef _INCLUDE_CMARKUPVOLUMEIMPL_H
#define _INCLUDE_CMARKUPVOLUMEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IMarkupVolume.h"
...
public:
    explicit CMarkupVolumeImpl(CMarkupVolume* p) : CBaseModelEntityImpl(p) {}

private:
    CMarkupVolume* Real() { return static_cast<CMarkupVolume*>(m_pReal); }
    CMarkupVolume* Real() const { return static_cast<CMarkupVolume*>(m_pReal); }

public:
    CMarkupVolume* GetOriginal() const override { return Real(); }
