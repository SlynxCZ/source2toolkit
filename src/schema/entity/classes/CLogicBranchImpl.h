...
#include "source2toolkit/schema/entity/classes/ILogicBranch.h"
...
private:
    ...
    CLogicBranch* Real() const { return static_cast<CLogicBranch*>(m_pReal); }

public:
    CLogicBranch* GetOriginal() const override { return Real(); }
