...
#ifndef _INCLUDE_CPATHCORNERCRASHIMPL_H
#define _INCLUDE_CPATHCORNERCRASHIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPathCornerCrash.h"
...
public:
    explicit CPathCornerCrashImpl(CPathCornerCrash* p) : CPathCornerImpl(p) {}

private:
    CPathCornerCrash* Real() { return static_cast<CPathCornerCrash*>(m_pReal); }
    CPathCornerCrash* Real() const { return static_cast<CPathCornerCrash*>(m_pReal); }
