...
#ifndef _INCLUDE_CTRIGGERBOMBRESETIMPL_H
#define _INCLUDE_CTRIGGERBOMBRESETIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerBombReset.h"
...
public:
    explicit CTriggerBombResetImpl(CTriggerBombReset* p) : CBaseTriggerImpl(p) {}

private:
    CTriggerBombReset* Real() { return static_cast<CTriggerBombReset*>(m_pReal); }
    CTriggerBombReset* Real() const { return static_cast<CTriggerBombReset*>(m_pReal); }
