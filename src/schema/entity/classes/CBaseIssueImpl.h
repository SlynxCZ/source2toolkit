...
#include "source2toolkit/schema/entity/classes/IBaseIssue.h"
...
private:
    ...
    CBaseIssue* Real() const { return static_cast<CBaseIssue*>(m_pReal); }

public:
    CBaseIssue* GetOriginal() const override { return Real(); }
