...
#include "source2toolkit/schema/entity/classes/IEnvDecal.h"
...
private:
    ...
    CEnvDecal* Real() const { return static_cast<CEnvDecal*>(m_pReal); }

public:
    CEnvDecal* GetOriginal() const override { return Real(); }
