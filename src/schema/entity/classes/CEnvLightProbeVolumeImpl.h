...
#include "source2toolkit/schema/entity/classes/IEnvLightProbeVolume.h"
...
private:
    ...
    CEnvLightProbeVolume* Real() const { return static_cast<CEnvLightProbeVolume*>(m_pReal); }

public:
    CEnvLightProbeVolume* GetOriginal() const override { return Real(); }
