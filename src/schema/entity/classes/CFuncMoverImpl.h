...
#include "source2toolkit/schema/entity/classes/IFuncMover.h"
...
private:
    ...
    CFuncMover* Real() const { return static_cast<CFuncMover*>(m_pReal); }

public:
    CFuncMover* GetOriginal() const override { return Real(); }
