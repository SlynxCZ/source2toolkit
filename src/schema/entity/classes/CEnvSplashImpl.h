...
#ifndef _INCLUDE_CENVSPLASHIMPL_H
#define _INCLUDE_CENVSPLASHIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IEnvSplash.h"
...
public:
    explicit CEnvSplashImpl(CEnvSplash* p) : CPointEntityImpl(p) {}

private:
    CEnvSplash* Real() { return static_cast<CEnvSplash*>(m_pReal); }
    CEnvSplash* Real() const { return static_cast<CEnvSplash*>(m_pReal); }

public:
    CEnvSplash* GetOriginal() const override { return Real(); }
