...
#ifndef _INCLUDE_CRULEBRUSHENTITYIMPL_H
#define _INCLUDE_CRULEBRUSHENTITYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IRuleBrushEntity.h"
...
public:
    explicit CRuleBrushEntityImpl(CRuleBrushEntity* p) : CRuleEntityImpl(p) {}

private:
    CRuleBrushEntity* Real() { return static_cast<CRuleBrushEntity*>(m_pReal); }
    CRuleBrushEntity* Real() const { return static_cast<CRuleBrushEntity*>(m_pReal); }
