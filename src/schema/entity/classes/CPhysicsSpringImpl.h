...
#include "source2toolkit/schema/entity/classes/IPhysicsSpring.h"
...
private:
    ...
    CPhysicsSpring* Real() const { return static_cast<CPhysicsSpring*>(m_pReal); }

public:
    CPhysicsSpring* GetOriginal() const override { return Real(); }
