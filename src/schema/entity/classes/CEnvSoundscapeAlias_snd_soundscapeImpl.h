...
#ifndef _INCLUDE_CENVSOUNDSCAPEALIAS_SND_SOUNDSCAPEIMPL_H
#define _INCLUDE_CENVSOUNDSCAPEALIAS_SND_SOUNDSCAPEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IEnvSoundscapeAlias_snd_soundscape.h"
...
public:
    explicit CEnvSoundscapeAlias_snd_soundscapeImpl(CEnvSoundscapeAlias_snd_soundscape* p) : CEnvSoundscapeImpl(p) {}

private:
    CEnvSoundscapeAlias_snd_soundscape* Real() { return static_cast<CEnvSoundscapeAlias_snd_soundscape*>(m_pReal); }
    CEnvSoundscapeAlias_snd_soundscape* Real() const { return static_cast<CEnvSoundscapeAlias_snd_soundscape*>(m_pReal); }
