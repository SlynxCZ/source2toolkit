...
#include "source2toolkit/schema/entity/classes/ICSGameModeRules_Deathmatch.h"
...
private:
    ...
    CCSGameModeRules_Deathmatch* Real() const { return static_cast<CCSGameModeRules_Deathmatch*>(m_pReal); }

public:
    CCSGameModeRules_Deathmatch* GetOriginal() const override { return Real(); }
