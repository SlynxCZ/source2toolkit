...
#ifndef _INCLUDE_CSHOWERIMPL_H
#define _INCLUDE_CSHOWERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IShower.h"
...
public:
    explicit CShowerImpl(CShower* p) : CModelPointEntityImpl(p) {}

private:
    CShower* Real() { return static_cast<CShower*>(m_pReal); }
    CShower* Real() const { return static_cast<CShower*>(m_pReal); }
