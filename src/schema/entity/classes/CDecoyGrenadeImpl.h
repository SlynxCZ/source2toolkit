...
#ifndef _INCLUDE_CDECOYGRENADEIMPL_H
#define _INCLUDE_CDECOYGRENADEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IDecoyGrenade.h"
...
public:
    explicit CDecoyGrenadeImpl(CDecoyGrenade* p) : CBaseCSGrenadeImpl(p) {}

private:
    CDecoyGrenade* Real() { return static_cast<CDecoyGrenade*>(m_pReal); }
    CDecoyGrenade* Real() const { return static_cast<CDecoyGrenade*>(m_pReal); }
