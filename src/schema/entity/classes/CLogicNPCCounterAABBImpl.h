...
#include "source2toolkit/schema/entity/classes/ILogicNPCCounterAABB.h"
...
private:
    ...
    CLogicNPCCounterAABB* Real() const { return static_cast<CLogicNPCCounterAABB*>(m_pReal); }

public:
    CLogicNPCCounterAABB* GetOriginal() const override { return Real(); }
