...
#ifndef _INCLUDE_CWEAPONSSG08IMPL_H
#define _INCLUDE_CWEAPONSSG08IMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponSSG08.h"
...
public:
    explicit CWeaponSSG08Impl(CWeaponSSG08* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponSSG08* Real() { return static_cast<CWeaponSSG08*>(m_pReal); }
    CWeaponSSG08* Real() const { return static_cast<CWeaponSSG08*>(m_pReal); }
