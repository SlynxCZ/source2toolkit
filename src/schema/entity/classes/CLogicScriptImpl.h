...
#ifndef _INCLUDE_CLOGICSCRIPTIMPL_H
#define _INCLUDE_CLOGICSCRIPTIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ILogicScript.h"
...
public:
    explicit CLogicScriptImpl(CLogicScript* p) : CPointEntityImpl(p) {}

private:
    CLogicScript* Real() { return static_cast<CLogicScript*>(m_pReal); }
    CLogicScript* Real() const { return static_cast<CLogicScript*>(m_pReal); }
