...
#ifndef _INCLUDE_CPHYSHINGEALIAS_PHYS_HINGE_LOCALIMPL_H
#define _INCLUDE_CPHYSHINGEALIAS_PHYS_HINGE_LOCALIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPhysHingeAlias_phys_hinge_local.h"
...
public:
    explicit CPhysHingeAlias_phys_hinge_localImpl(CPhysHingeAlias_phys_hinge_local* p) : CPhysHingeImpl(p) {}

private:
    CPhysHingeAlias_phys_hinge_local* Real() { return static_cast<CPhysHingeAlias_phys_hinge_local*>(m_pReal); }
    CPhysHingeAlias_phys_hinge_local* Real() const { return static_cast<CPhysHingeAlias_phys_hinge_local*>(m_pReal); }
