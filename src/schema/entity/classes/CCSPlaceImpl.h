...
#ifndef _INCLUDE_CCSPLACEIMPL_H
#define _INCLUDE_CCSPLACEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSPlace.h"
...
public:
    explicit CCSPlaceImpl(CCSPlace* p) : CServerOnlyModelEntityImpl(p) {}

private:
    CCSPlace* Real() { return static_cast<CCSPlace*>(m_pReal); }
    CCSPlace* Real() const { return static_cast<CCSPlace*>(m_pReal); }

public:
    CCSPlace* GetOriginal() const override { return Real(); }
    CUtlSymbolLarge& Name() override { return Real()->m_name(); }
