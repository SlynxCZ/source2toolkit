...
#include "source2toolkit/schema/entity/classes/IFuncLadder.h"
...
private:
    ...
    CFuncLadder* Real() const { return static_cast<CFuncLadder*>(m_pReal); }

public:
    CFuncLadder* GetOriginal() const override { return Real(); }
