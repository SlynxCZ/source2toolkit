...
#ifndef _INCLUDE_CFILTERLOSIMPL_H
#define _INCLUDE_CFILTERLOSIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IFilterLOS.h"
...
public:
    explicit CFilterLOSImpl(CFilterLOS* p) : CBaseFilterImpl(p) {}

private:
    CFilterLOS* Real() { return static_cast<CFilterLOS*>(m_pReal); }
    CFilterLOS* Real() const { return static_cast<CFilterLOS*>(m_pReal); }
