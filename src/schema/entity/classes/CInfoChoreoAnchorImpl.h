...
#include "source2toolkit/schema/entity/classes/IInfoChoreoAnchor.h"
...
private:
    ...
    CInfoChoreoAnchor* Real() const { return static_cast<CInfoChoreoAnchor*>(m_pReal); }

public:
    CInfoChoreoAnchor* GetOriginal() const override { return Real(); }
