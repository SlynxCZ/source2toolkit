...
#ifndef _INCLUDE_CCSMINIMAPBOUNDARYIMPL_H
#define _INCLUDE_CCSMINIMAPBOUNDARYIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ICSMinimapBoundary.h"
...
public:
    explicit CCSMinimapBoundaryImpl(CCSMinimapBoundary* p) : CBaseEntityImpl(p) {}

private:
    CCSMinimapBoundary* Real() { return static_cast<CCSMinimapBoundary*>(m_pReal); }
    CCSMinimapBoundary* Real() const { return static_cast<CCSMinimapBoundary*>(m_pReal); }
