...
#include "source2toolkit/schema/entity/classes/IMarkupVolumeWithRef.h"
...
private:
    ...
    CMarkupVolumeWithRef* Real() const { return static_cast<CMarkupVolumeWithRef*>(m_pReal); }

public:
    CMarkupVolumeWithRef* GetOriginal() const override { return Real(); }
