...
#ifndef _INCLUDE_CHEGRENADEIMPL_H
#define _INCLUDE_CHEGRENADEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IHEGrenade.h"
...
public:
    explicit CHEGrenadeImpl(CHEGrenade* p) : CBaseCSGrenadeImpl(p) {}

private:
    CHEGrenade* Real() { return static_cast<CHEGrenade*>(m_pReal); }
    CHEGrenade* Real() const { return static_cast<CHEGrenade*>(m_pReal); }
