...
#include "source2toolkit/schema/entity/classes/IEnvInstructorHint.h"
#include "schema/entity/classes/CEnvInstructorHint.h"
#include "CPointEntityImpl.h"

class CEnvInstructorHintImpl : public CPointEntityImpl, public virtual IEnvInstructorHint
{
...
private:
    ...
    CEnvInstructorHint* Real() const { return static_cast<CEnvInstructorHint*>(m_pReal); }

public:
    CEnvInstructorHint* GetOriginal() const override { return Real(); }
...
inline IEnvInstructorHint* CEnvInstructorHint::ToInterface()
{
    static const char s_tag = 0;
    auto& byTag = virtualhooks::entityInterfaces[this];
    auto tagIt = byTag.find(&s_tag);
    if (tagIt != byTag.end())
        return static_cast<IEnvInstructorHint*>(tagIt->second.ptr_for_return);
    auto* impl = new CEnvInstructorHintImpl(this);
    byTag[&s_tag] = virtualhooks::EntityImplEntry(static_cast<IEntityInstance*>(impl), static_cast<IEnvInstructorHint*>(impl));
    return impl;
}
inline IEnvInstructorHint* IEnvInstructorHint::FromRaw(CEntityInstance* p) { return p ? static_cast<CEnvInstructorHint*>(p)->ToInterface() : nullptr; }
inline IEnvInstructorHint* IEnvInstructorHint::FromOriginal(CEnvInstructorHint* p) { return p ? p->ToInterface() : nullptr; }
