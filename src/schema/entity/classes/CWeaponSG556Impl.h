...
#ifndef _INCLUDE_CWEAPONSG556IMPL_H
#define _INCLUDE_CWEAPONSG556IMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IWeaponSG556.h"
...
public:
    explicit CWeaponSG556Impl(CWeaponSG556* p) : CCSWeaponBaseGunImpl(p) {}

private:
    CWeaponSG556* Real() { return static_cast<CWeaponSG556*>(m_pReal); }
    CWeaponSG556* Real() const { return static_cast<CWeaponSG556*>(m_pReal); }
