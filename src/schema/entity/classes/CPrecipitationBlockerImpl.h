...
#ifndef _INCLUDE_CPRECIPITATIONBLOCKERIMPL_H
#define _INCLUDE_CPRECIPITATIONBLOCKERIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPrecipitationBlocker.h"
...
public:
    explicit CPrecipitationBlockerImpl(CPrecipitationBlocker* p) : CBaseModelEntityImpl(p) {}

private:
    CPrecipitationBlocker* Real() { return static_cast<CPrecipitationBlocker*>(m_pReal); }
    CPrecipitationBlocker* Real() const { return static_cast<CPrecipitationBlocker*>(m_pReal); }
