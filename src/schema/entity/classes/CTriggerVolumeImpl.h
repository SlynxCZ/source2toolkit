...
#ifndef _INCLUDE_CTRIGGERVOLUMEIMPL_H
#define _INCLUDE_CTRIGGERVOLUMEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/ITriggerVolume.h"
...
public:
    explicit CTriggerVolumeImpl(CTriggerVolume* p) : CBaseModelEntityImpl(p) {}

private:
    CTriggerVolume* Real() { return static_cast<CTriggerVolume*>(m_pReal); }
    CTriggerVolume* Real() const { return static_cast<CTriggerVolume*>(m_pReal); }

public:
    CTriggerVolume* GetOriginal() const override { return Real(); }
