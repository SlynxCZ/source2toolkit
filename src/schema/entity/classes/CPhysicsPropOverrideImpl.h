...
#ifndef _INCLUDE_CPHYSICSPROPOVERRIDEIMPL_H
#define _INCLUDE_CPHYSICSPROPOVERRIDEIMPL_H

#pragma once

#include "source2toolkit/schema/entity/classes/IPhysicsPropOverride.h"
...
public:
    explicit CPhysicsPropOverrideImpl(CPhysicsPropOverride* p) : CPhysicsPropImpl(p) {}

private:
    CPhysicsPropOverride* Real() { return static_cast<CPhysicsPropOverride*>(m_pReal); }
    CPhysicsPropOverride* Real() const { return static_cast<CPhysicsPropOverride*>(m_pReal); }
