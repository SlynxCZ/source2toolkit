...
public:
		...
		m_pPawn(pPawn), m_nItemDefIndex(nItemDefIndex), m_nCount(nCount)
	{
		...
		static const auto pVTable = DynLibUtils::CModule(g_pSource2Server).GetVirtualTableByName("WeaponPurchaseCount_t");
		((void**)this)[0] = reinterpret_cast<void*>(pVTable.GetPtr());
	}
