/* Breakpad build configuration for the Windows (MSVC) build of the toolkit's
   crash handler. What autoconf would have produced; taken from AcceleratorCS2,
   which builds the same breakpad pieces with it. The fork includes it as
   <configs.h>. */
